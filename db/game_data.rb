[
    {
        ...
        :also_known_as => [],
                 :name => "10 Fingers",
          :description => "Great game for getting to know each other in a new group. All players in a circle, holding all 10 fingers up in the air. One person at a time, start asking personal questions that take yes-no answers; whoever cannot answer yes to a question, drops a finger. Last person with a finger left wins. Good questions are things like \"I have a cat\", \"I have never stolen anything\" and so on."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "3 some",
          :description => "Fun warm-up. One player offers something, e.g. I am a slice of cheese. 2nd player jumps in and adds something to the offer, e.g. I am a slice of bread. 3rd player jumps in and again adds to the setup, e.g. I am a pickle. First player leaves, taking one of the others with him. Restart from the remaining player, who restarts by saying what/who she is."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [
            "ACE - for Action, Color, Emotion"
        ],
                 :name => "Narrative, Color, Emotion",
          :description => "One players tells a story, solo. 3 other players tag the player if they want to hear more action (narrative), more emotion or more color. By color we mean environmental detail, as in how does it smell, temperature, weather, colors, sounds."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [
          ...
          :description => "A scene is started, played by 2 to 4 players. Mid-scene the MC interrupts, and all characters are replaced by new players. The new players should take over the original characters, and stick to the story that was being developed."
    },
    {
             :see_also => [
            "Hat Continuation"
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Adjective Scene",
          :description => "Ask for an adjective (e.g. sad). Play a scene in which the players are as sad as possible. Alternatively, give every player a different adjective."
    },
    {
             :see_also => [],
           :variations => [
            "At a second clap, allow the player to advance the scene."
        ],
        :also_known_as => [
    ...
    },
    {
        ...
        :also_known_as => [
            "Ahab and the Whale"
                 ...
                 :name => "Three Rules",
          :description => "Get 3 rules from the audience, e.g. players have only one arm, players can`t use a word that contains an `s` and after every question uttered players needs to yell `Yess!`. Players then play a scene, obeying the 3 rules. For examples of what else might be used as a rule see the other games in the Limitations category."
    },
    {
             :see_also => [
            "Fingertips"
        ...
        :also_known_as => [
            ...
            "Obstacle Course"
                 ...
                 :name => "Blind Lead",
          :description => "One player is blindfolded, and the room is filled with obstacles (put a couple of chairs everywhere, leave all kinds of junk on the floor). The idea is that the rest of the group will lead the blindfolded player through the room, by talking. n"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
          ...
          :description => "Excellent warm-up. Everyone in a circle. We are going to establish a rhythm, by saying, all together `Ali Baba and the 40 Thieves`. Keep repeating this. One person starts making a gesture to this rhythm, say, tapping your head with you left hand. When the sentence is repeated, the player next to her takes over this gesture, while the first one starts a completely different new gesture. Third time the sentence is done, player three does the first gesture, player two does the second gesture and player one invents a new one again. And so on. This is also a concentration game, though it`s not really difficult. All one has to do is watch the previous player, and next time, take over her gesture. When you`re watching what everyone else is doing you`re going to get lost though."
    },
    {
             :see_also => [],
           :variations => [
            "Invent your own animals (or things) and let players become juke boxes, birds, whatever. Play `majority wins`: animals/things that are most in the minority drop out."
        ],
        :also_known_as => [
            "Rock Paper Scissors"
        ],
    ...
    },
    {
        ...
        :also_known_as => [
            "Alliances"
                 ...
                 :name => "Excluding",
          :description => "4 players play a scene, in which one of the players gets excluded."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Alliteration Introduction",
          :description => "Excellent game for players to get to know each other`s names. Everyone in a circle. A player starts the game by introducing himself by making a gesture, and alliterating to his name, e.g. \"I`m Wonderful Wendy\" or \"I`m Smart Steve\". The next player point to the first, repeats the previous player`s name, attribute and gesture, and does something similar about himself. And so on. Game ends with the first player having to do each other player`s gesture, repeating their names and attributes."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "Great warm-up game to sharpen concentration. Everyone in a circle. One player starts by throwing an `A` to another player. That player throws as fast as possible a `B` to someone else. And so on. If you work with a large group, you can divide them into 2 circles, call `em Team Gold and Team Silver, and time how fast they can get to `Z`."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "Players in groups of 4 or 5. When a letter is called, each group forms that letter with their bodies."
    },
    {
             :see_also => [
            "Commenting",
    ...
    },
    {
        ...
        :also_known_as => [
            "Totems"
                 ...
                 :name => "Animalistics",
          :description => "Ask the audience for animals. Players play a scene, in which the characters are based on these animals."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Animals",
          :description => "Make sure you have an even number of players. Give everyone an animal, but make sure that there are 2 of each, and that nobody knows which other player is which animal. Then give a number of activities, which the animals perform. Try Eating. Eating when you`re really hungry Drinking. Drinking when you`re really thirsty Lovemaking Grooming Fighting Sleeping At the end, ask the players to find the other animal of their kind. Ask the others if they found out who was which animal."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Armando",
          :description => "This is a long form, named after its creator, Chicago Improv teacher and player Armando Diaz. This improv format starts with a storytelling-style monologue, based on an audience suggestion. After the monologue, players play improvized scenes inspired by the monologue, and the monologue may even continue, later on in the performance."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [
            "Arm Game"
                 ...
                 :name => "Helping Hands",
          :description => "Scene played by 4 players, playing 2 characters. Each character consists of one player, who does the voice, holding his hands behind his back. Another player stands behind player 1, and provides the `hands`. The story should be a give and take between voices and hands."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Artist Model Clay",
          :description => "3 players. One is a lump of clay - behind her is a second player who is a model. Model takes a pose, which the `clay` is not supposed to see. The third player becomes the artist, who will model the clay after the model. The artist is not supposed to touch the clay, can`t speak and it not allowed to show the clay what to do or to become. When done, let the model inspect the artwork and see if details fit."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [
            "Attenborough"
                 ...
                 :name => "Narrator",
          :description => "This improv format is like Typewriter without the typewriter: players improvise a scene, which a narrator describes and comments upon."
    },
    {
                :notes => [
    ...
    },
    {
        ...
        :also_known_as => [
            ...
            "Half Life"
                 ...
                 :name => "Scene Replay",
          :description => "Ask 2 players to play a short scene. One could limit the scene to 8 lines of dialog per player. Then ask the players to replay the scene, based on some audience suggestions for: a particular emotion."
    },
    {
             :see_also => [],
           :variations => [
            "Drop the dance, and have players do a scene sitting back-to-back. In the scene the characters need not be static; they may be walking, running, performinc any activity; it's just the players who are sitting down."
        ],
        :also_known_as => [
            "Back to Back"
        ],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Balladeer(2)",
          :description => "This is like the short form version Balladeer(1) , but in this long form improv format, as soon as the balladeer stops singing or finishes the song, the characters start playing and talking independently. When their scene is done the balladeer starts a new song, and so forth."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Bartender",
          :description => "A silly Short Form handle: ask for a silly problem. Player 1 goes into a bar and explains his woes to the bartender in an improvized song. The bartender then fixes the problem in another improvized song."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Beasty Rap",
          :description => "This one is in the SingSong category but it's equally a fun warmup. Everyone in e circle and get a beat running; use a beatbox, cd or mp3. First player starts rapping a line, any line, on the beat. Without skipping too many beats, next player adds a line that rhymes and so on until a player fails to come up with a line, misses the beat or fails to rhyme, after which everybody goes 'Dang', and the next player starts a next round. When the players not rapping feel the rhyme word of the active player coming, they all join in and yell the word together at the end of every line. For (not improvised) inspiration check out 'Intergalactic' by the Beasty Boys."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "A short scene is improvised. After that the host asks the audience whether they want to see what happened before this scene, or what happens after this scene. This is a variation on the Fast Forward improv game."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Bidirectional Satellite TV",
          :description => "Fairly difficult combination of the Satellite TV and Satellite Radio improv games: players in pairs, establish a beat. Every beat, player 1 offers a movement and player 2 offers a word of a story. At the same time, players mirror each other, with a delay of 1 beat."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Big Blob",
          :description => "nPlayers perform a scene in a location that contains an enormous blob of blubber. Something yukkie. Players must walk or move through this blob as the scene continues, but their characters are not supposed to acknowledge that this Big Blob is there."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "Fun energizer game. Everyone in a circle. We are going to pass a pattern along the circle. Everyone, at their turn does either: Say Big Fish, and hold both hands in front of you, about 3 inches or 10cm apart. \"It\" then passes to the next person in the circle. Say Small Fish, and hold both hands in front of you, about 15 inches or 50cm apart. When this is done, the direction changes. Players that miss (e.g. say Small Fish and keep your hands too close together or say Big Fish and move hands wide) do a forfeit, or die with a loud noise."
    },
    {
             :see_also => [
            "Bippety Bop(1)"
        ...
        :also_known_as => [],
                 :name => "Bippety Bop(2)",
          :description => "This is a variation on Bippety Bop(1) : all players in a circle, one player in the middle who is `it`. This player picks a player in the circle and yells `bippety-bippety-bop` at her. If he manages to get to `bop` before she can say `bop`, she becomes `it`. Other possibilities are: Just say `bop` if anyone else reacts, that person becomes `it` Say `Elephant`, after which 3 players build the elephant: the player picked does the trunk (hold nose and squeeze your other arm through) and her neighbors do the ears. If any of the 3 players screws up or does not react he or she becomes it. Say `mixer`: the player in the middle becomes a mixer, holding arms up in the air, sort of horizontally, while her neighbors position themselves under her hands, and turn around their axises Say `toaster` : the player in the middle becomes a slice of bread, and her neighbors become the toaster, by `building` the toaster with their arms around the bread. The slice of bread pops up an down too when done! Feel free to invent other objects (suggestions can be found under Bippety Bop(1) )."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Black Box",
          :description => "This improv game is played by 2 players. One holds a (mimed) black box, which has 3 buttons, one of which is red. These buttons control a player; one button might be the `jerk your leg` button. The exact functions of each button are not defined. The other player enters and asks if he can play with the box. Player 1 agrees, but adds something like \"Whatever you do, don`t push the red button\". Player 2 begins to play with the buttons, controlling player 2. Then, we slowly work up to the use of the dreaded red button, which will make player 2 do something not-so-obvious. This can be anything, but it should not be preconceived. The red button might become a Mood swing button, a Start Screaming, Start Giggling, Sing Opera, or Switch-to- Gibberish button."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Blind Association Circle",
          :description => "This one starts just like Free Association Circle : players in a circle, establish a rhythm, and freely associate on previous player`s word. As this is going on, the trainer will tap all players gently on the shoulder, at 3 times: first tap: players close their eyes but continue the free association, sticking to the rhythm second tap: everyone starts walking around (carefully!), eyes still closed.Players have to recognize the voice of their ex-neighbour in the circle to know when it`s their turn. Third tap: all players, still eyes closed, and still associating, try to reconstruct the circle. Exercise is over when everyone is in a circle again. Trainer should keep an eye on players to make sure they don`t run into things. It helps if there`s not too much clutter around, of course."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Blind Freeze",
          :description => "This one is just like Freeze Tag , but here the MC calls Freeze, and calls in another player. If you`re not using an MC, any player might call Freeze and call in any other player. Many groups find this game more exciting than Freeze Tag , as players don`t know when they get pushed in the game, and hence are less prepared, and crazier, more exciting stuff tends to happen."
    },
    {
             :see_also => [
            "The Bat"
        ...
        :also_known_as => [],
                 :name => "Blind Harold",
          :description => "This is really a listening exercise, though it has been performed as a Long Form for audiences. Basically, this is a Harold , played with all players sitting down with their eyes closed. For a performance one would turn all the lights off in the theater."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Blind Line Offers",
          :description => "Line up the players, give`em each a number. Call out 2 numbers. Those players step on stage immediately, with a physical Offer (do something, eat an apple, wipe the floor, whatever) as well as a vocal offer (say something). The idea is that the players accept and explore each other`s offers and figure out what the scene is about."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Blind Musical",
          :description => "This is like a musical version of Pockets : ask the audience to write simple sentences on slips of paper. Hand each player 2 or 3 slips (they`re not allowed to read them yet). Play a scene or series of improvized scenes. Players draw slips of paper at random, and every time they do, they start a song that starts with the sentence on the slip. Try to integrate the info on the slips into the story, of course!"
    },
    {
             :see_also => [],
           :variations => [
            "Have the players play barefoot and have mousetraps on the stage. Not very nice but we`ve seen it done."
        ],
        :also_known_as => [
            "Mousetraps"
        ],
                 :name => "Blindfolded Scene",
          :description => "Players are blindfolded and then play a scene."
    },
    {
             :see_also => [
            "Death and Retriever"
           ...
           :variations => [
            "When a `vampire` runs into a victim, the victim becomes a vampire too When 2 vampires bump into one anther, they become normal mortal souls again"
        ],
        :also_known_as => [
            "Blind Hunt",
            "Screamers",
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Blues Jam",
          :description => "Ask the audience for 5 things that give them the blues. Then improvise a blues jam about those elements."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Bobsledding Bodies",
          :description => "This is a physical team game. Form teams of 4 - 6 players. Teams sit in a line and wrap their legs around the person in front of them. Place masking tape about 10 - 15 feet away to mark the end line. On \"GO\", teams must only use their hands to slide their way to the end. If a team breaks apart, they must get back together before they continue."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Bong Bong Bong",
          :description => "Silly game, inspired by a Korean TV show (so we`re told). 4 players, 3 stand with their ears closed, backs turned to the scene. The 4th player gets as a suggestion a common expression. The idea is that this player has 1 minute to communicate this suggestion to the 2nd player, using only mime and Gibberish . Number 2 then communicates (what he has understood) to number 3, who does the same to number 4. At the end yell Bong Bong Bong and have players 2, 3 and 4 explain what they thought they understood. A similar technique is used in LCD ."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Bucket",
          :description => "Before the show ask the audience to write simple sentences on slips of paper. Those go in a big bucket. A scene is improvized, and at random moments the players don`t just invent a line of dialog, but use a line off a piece of paper drawn from the bucket. Anything said is accepted, heightened and integrated."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [
            ...
            "Head in Bucket"
                 ...
                 :name => "Dry Cleaning Bag of Death",
          :description => "We need three or four players for this improv game. During an improvized scene, one player is always off-stage, with his head inside a dry cleaning bag, slowly suffocating. He is not allowed out of the bag until some other player finds a way to to exit the scene and `liberate` the suffocating player. New player puts his head into the bag until freed by another player, and first liberated player finds a way to justify his entrance into the scene."
    },
    {
             :see_also => [],
           :variations => [
            "The person in the middle can randomly yell out bumpity bump bump bump and everyone has to find a new spot on the edge of the circle."
        ],
        :also_known_as => [],
                 :name => "Bumpity Bump",
    ...
    },
    {
           ...
           :variations => [
            "Play in slow motion. Hilarious! Alternatively, you can really invent any object or create or replace the bunny, as long as you invent a sound along with it. Try r a car, with 2 wheels and a set of wind screen wipers, going `vroom vroom` a cow, with an udder and 2 horns, going `moo moo` a washing machine, with 2 players building a `box` with both arms, and the middle player waving her arms in a circle in front of her. All go `rumble rumble` an elephant, with 2 big ears and a trunk, making an elephant sound (if you don`t know what an elephant sounds like, just invent a sound)."
        ],
        :also_known_as => [],
                 :name => "Bunny",
          :description => "Extremely silly game, to pump up the energy. Get everyone in a circle. One player becomes the body of a bunny - this is done by holding both arms in front of your chest, elbows touching your rib cage, and letting hands hang. Her 2 neighbors become the `ears` of the bunny, by waving a hand next to the middle player`s ears. All 3 say `bunny bunny bunny` together, until the middle player `throws` a `bunny` to another player in the circle. This player becomes the bunny body, and his neighbors get to do the ears. Play this game at a high speed. Mumbling `bunny bunny` en masse gives a nice energy boost."
    },
    {
             :see_also => [],
           :variations => [
            "You can come up with any sentence that needs to come up. A variation would be to use \"I`ll have a coke\" -"
        ],
        :also_known_as => [
            "I`ll Have a Coke"
        ],
                 :name => "Call from Ray",
          :description => "A scene is begun. At some point in the scene an onstage player has to receive a \"Call from Ray\" (or any other name agreed upon). The call can come in any form, like phone call, SMS, smoke signals, telepathy or whatever, and Ray himself may not appear in the scene."
    },
    {
             :see_also => [],
           :variations => [
            "Players can only see their own card, but not the others` give players multiple cards, and let them switch cards in the middle of the scene. Statuses (statii ??) should change accordingly. as an exercise, let players play a scene and then ask them to line up in status order to see if they `got` their status right."
        ],
        :also_known_as => [],
                 :name => "Card Status",
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Cards",
          :description => "Ask the audience to write short sentences on cards. Give 2 players 3 cards, which they put in their pockets. Then they play a scene. At any point in time, instead of saying whatever they think they might say, they take a card, and read what`s on the card. Whatever is said should be justified."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Cat and Mouse",
          :description => "All players in pairs. One player is cat, one other player is mouse, and all others stay in pairs, arms hooked together. Cat chases mouse; when mouse is caught then mouse becomes cat and vice versa. However, mouse can escape chase by hooking into any pair of other players. At that point the player at the other end of the pair becomes cat and the cat becomes mouse."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Circle Sitting",
          :description => "Have everyone stand in a circle, really close to each other, facing inwards. Then ask everyone to make a quarter turn left. Make everyone stand even closer to each other. When ask the whole group to sit down. If everyone is really close, they will end up sitting on one another`s knees, and the whole construction supports itself. If well done it`s even possible to make the circle walk. Indicate which foot to start with ;-)"
    },
    {
             :see_also => [],
           :variations => [
            "You can use this for both Last Letter games or Free Association Circle . Try this with two circles. Have one circle associate freely, and another circle on Last Letter. Whenever a player misses a beat she should switch circles. If you do the variation with 2 circles, you will probably find that the rhythms for both circles synchronize."
        ],
        :also_known_as => [],
                 :name => "Clap Snap Association",
          :description => "This one is like a Free Association Circle , except that the rhythm is more explicit. Here`s how to do the rhythm: each beat consists of 4 phases: Slap both hands on your thighs Clap your hands Snap your left hand fingers Snap your right hand fingers With every right hand snap, a word should be thrown to your neighbor. Once the rhythm is established, you can leave out the snaps - that`ll make things more understandable."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Clap Snap Stamp",
          :description => "All players in pairs, facing each other. We`re going to count from one to three, each player one number at a time, and we keep repeating this. So player number one would go one, three, two, one, three, and so on. Once they get this, we replace the `one` with a `snap` (snap your fingers). Once everyone is into that, we replace the `two` as well, with a hand-clap. Finally, we replace the `three` as well, with a stamp of the right foot. Play at high speed!"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Click Bang You're dead",
          :description => ": all players sit in a circle. Only one player should know how to play and what the secret is; this player is the leader at first, until others catch on. This person points at random people in the circle each time saying either \"click\" or \"bang\"; they should make it sound and look like what theyâ\u0080\u0099re doing has to do with math or the order they are going etcâ\u0080¦ The secret: it really doesnâ\u0080\u0099t matter who is pointed to, what is said, when they are pointed to, who it begins with or who it ends with, it just depends on who speaks first after the clicks and bangs are done. So the person who begins (the one that knows whatâ\u0080\u0099s going on) will declare whoever talks first dead by saying \"youâ\u0080\u0099re dead\". That person isnâ\u0080\u0099t \"out\" or anything, itâ\u0080\u0099s just for effect. The game continues until the players catch on. If somebody thinks they get it, the leader gives them a chance to say the clicks and bangs and they get to announce who is dead; the leader will then be able to tell if they understand the secret if they announce the right person as being dead. Make sure that once the players begin to catch on, they donâ\u0080\u0099t spoil it for the others by letting the cat out of the bag. Also, the game is best if played with ten or more people. Contributed by Jeannie Smith from Hawai. Thanks for that Jeannie!"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Cloud Atlas",
          :description => "Cloud Atlas is a book by author David Mitchell, which has a peculiar structure. The same structure can be used to create a Long Form improv show. For details on the book (spoiler alert) see . Here is how the format works: it is a long form show with an intermission. Before the break, a number of stories (6 stories in the original book, but any number above 2 will work) are half told; these stories take place in history, time running forward, and each story is played in a particular, different style. After the break, the stories are finished, one after the other, but in inverse order. By the end of the show, the stories should have connections between them. An example to clarify. Ask 4 suggestions of historical periods & locations, in historical order. The (near & far) future are allowed. Suppose we get: french revolution, first world war Britain, today (2013-ish) USA and 2030 China. This will lead to 4 story lines, and 8 parts, 4 before the break and 4 after. Each story line is played as a Straight Story . For example: Story 1/part 1: Dramatic story in france during revolution Story 2/part 1: Love story during WW1 Story 3/part 1: Thriller in USA, current time Story 4/part 1: Musical in post-communist China Break Second half of story 4 Second part of story 3 Second half of story 2 Second part of story 1 There should be a link from story 1 to story 2, one from story 2 to story 3 and one from story 3 to story 4. All the links should be different in kind and not be purely thematic, e.g. a book written by a character in story 1 may be important in story 2; an invention done in story 2 may be linked to a character's profession in story 3 and so forth. If one link is a character the other links should not be characters. Ideally, not all links are established before the break. For a really concrete example see the wikipedia link on the plots in Mitchell's book. Origin Original book by David Mitchell, 2004. Idea of using the structure for a long form is attributed to Tom Tollenaere."
    },
    {
             :see_also => [],
           :variations => [
            "Use both hands. Origin Described in Augusto Boal `s Games for Actors and Non-actors ."
        ],
        :also_known_as => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "ComedySportz",
          :description => "ComedySports was started by Dick Chudnow in 1984 in Milwaukee. It`s a format of competitive improv comedy that resembles Keith Johnstone `s Theatresports . The format is currently played by a dozen-plus teams all over the USA, united in the Comedy League of America. In a ComedySportz show 2 teams complete for points given by the audience. A referee oversees the match, times the games, calls fouls and gets audience suggestions. A match consists of something like 7 to 12 games, drawn from a repertoire of over a hundred improv games (you`ll find most of these games in the Games section of Improv Encyclopedia). In terms of gimmicks, you have the `brown bag foul`, which is a brown paper bag placed over the offending player`s head."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Commercial",
          :description => "Ask for a product (existing or non-existing). Then play a commerical for that product."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Communal Monologue",
          :description => "All improvisers in a circle. One player in the middle, and that player starts improvising a monologue. At any point in time, any other player may step (or rather glide) in and take the middle's player's place, and continue the monologue. The transitions should be smooth of course."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Complete Bodies",
          :description => "Players in pairs. One player takes a position, using all parts of her body. The other player completes that position, by folding over/in/around the first player, without touching her. First player then completes second player in another pose, again without touching. As a next step, do the same, but tell a story, one sentence at a time, providing a sentence every time you move."
    },
    {
             :see_also => [
            "Big Booty"
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Concentration Circle",
          :description => "Place all players in a circle and number them sequentially, starting with a random player. The players then establish a rhythm, for example by swinging their left hands up and down. Have player 1 start; when her arm is up she shouts/throws a number. The player with that number needs to throw another nnumber at the next beat. Players that fail (if they did not recognize their own number) or that break the rhythm become the last player in the circle, and that changes the numbers for a bunch of players. Restart with player one."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Confessions",
          :description => "Not exactly theater but fun when played well. The MC gets a bunch of `confessions` from the audience. These can be really lame, like e.g. `I vote democratic`, `I used to be a man`, `I sold a kidney`, whatever. Then players line up. One player steps forward, and gets a confession from the host. Player utters the confession in a character, and immediately another player jumps in and offers a witty reply. Do this as long as players have ideas for replies. Then replace the first player by a new one, give her a new confession and repeat ad libitum."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Continuing Emotions",
          :description => "A 'neutral' improvized scene is started, and is then interrupted (frozen) several times by the MC. The scene is then continued but all characters switch to an emotion provided by the audience."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Continuing Styles",
          :description => "A 'neutral' improvized scene is started. This scene gets interrupted several times by the MC, and then continued in a film/ literature/ drama/ TV-program style provided by the audience. The platform and the story need to continue flawlessly."
    },
    {
             :see_also => [],
           :variations => [
            "Feel free to actually continue the ongoing scene rather than to start a completely new one. Feel free to replace all the players instead of just the player who said the last line. Rather than just stepping in and repeating a line, you might want to call `FLIP` (or freeze). This variation is known as"
        ],
        :also_known_as => [
            "FLIP"
        ],
                 :name => "CopyCat",
          :description => "CopyCat goes like a verbal Freeze Tag. A scene is started. At any time, a player at the side can step forward (the playing players hold off for a moment) and repeats a line that was said in the scene. Whoever originally said that line, steps aside, and the remaining players start a new scene starting with the line that was repeated."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Crabtrees Conundrum",
          :description => "This game is taking from Mrs. Crabtree from South Park. 2 players start a scene and every now and then a player will say \"What`d you say?\" And the other player must come up with a completely different phrase that rhymes with the one just said. For instance. Christine, I think you are as sick as a dog!! What`d you say? I said I think we should go for a jog, it`s a really nice day.. and so forth. See Ding for a similar game."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
          ...
          :description => "Two players chase each other about the room. The player that is being chased mimes obstacles for the other, who then has to overcome these obstacles."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Crime Endowments",
          :description => "One player is endowed as the head of a criminal organization and gathers with the others to plan or act out the crime. He is endowed with â\u0080\u009Csomething to steal, hijack or kill, â\u0080\u009Ca method or weapon, and some wild card such as a code word or i a disguise. This is sort of a generalisation of Hijacker ."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
          ...
          :description => "Great exercise for spontaneity. 2 players on stage approach each other with a crisis, and an object unrelated to the crisis. After each has presented his or hers, each solves the other`s crisis with their own object. Replies must be instantaneous and may be ridiculous. Example: Player A: My wife left me and I`m stuck here with this t-shirt Player B: I got robbed and all I have left is my good looks. Player A: Here`s my t-shirt; you can sell it and make some money. Player B: Erm... Marry me."
    },
    {
             :see_also => [],
           :variations => [
            "Instead of calling names, players can pick another player by making eye contact (and nodding to acknowledge that eye contact has been made). This demands a lot of concentration. You can have more than one cycle going, if the group is big enough."
        ],
        :also_known_as => [
            "Name Game",
            "Shriner's Warm-up"
                 ...
                 :name => "Cross Circle",
          :description => "Perfect game to learn each other's names. Everyone in a circle. One person (A) starts by calling another person`s name (B). At that point, A starts walking towards B. Before A gets to B, B needs to call another name (C), so B frees her spot in the circle, for A to take. C then needs to call yet another name and start walking, so B can take C`s spot."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Cross the Circle",
          :description => "Have everyone sit in a circle with one person in the center. Person in the middle names something you have, have done, or can do (e.g. â\u0080\u009CCross if you have ever jumped out of a plane, if you own a dog, have blue eyes\"). Those people that can give a positive answer to the question will cross the circle and find an open spot of someone else that answered positively. There should be one person left in the center. This person then gets to pick the topic."
    },
    {
             :see_also => [],
           :variations => [
            "Usually, we decide on a category before the start of this game. Possible categories are Soap series, like The Bold and the Beautiful, Dallas, Eastenders Hospital drama, like E.R. Cop drama, like Hill Street Blues Romantic Comedy, like The Love Boat Crime series or murder mysteries"
        ],
        :also_known_as => [
            "Soap"
        ],
                 :name => "Cut",
          :description => "This Long Form improv game is played with 6 to 15 players. 2 players start a scene, perhaps based on an audience suggestion. In the middle of the scene, any other player can call `Cut`, and start another scene, dragging one or more other players in the scene. n All scenes are interrupted this way, and the idea is that all scenes come together in one story. Cut scenes can be continued later. Usually, every player sticks to one character. This game can be played with or without a director. Also know as"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Dating Game",
          :description => "This is played like a Blind Date show. One player leaves the stage, and the audience provides endowments for the 3 others. Examples might be No. 1 is stupid, No. 2 is a serial killer and No. 3 thinks he`s a macho. 4th player gets to ask 3 questions, and each of the others answers it. After the questions player 4 should guess what the endowments were."
    },
    {
             :see_also => [
            "Ding Dong"
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Deaf Replay",
          :description => "2 players play a scene while 2 others watch the scene, with their ears covered. When the scene is over, the 2 others re-play the scene. Obviously they`ll do the same movements, but the dialogue will be different."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Death and Retriever",
          :description => "This one is like Scorpion , but in this version killed players are not `out`, but can be revived. Everyone eyes closed, one player becomes the killer (tap him on the shoulder) and another one becomes the retriever. The retriever gets a towel of a scarf around her neck. Dead players scream when they are killed, keep their eyes closed and stand still. When the retriever bumps into someone that does not move (a dead body) she can revive the dead by rubbing them with the towel. When the retriever gets killed, she screams and stops moving. When another living person bumps into the retriever (recognized by the scarf), the retriever is revived, and the one that revived the retriever becomes the new retriever. Play till everyone is dead or bored."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [
            "Digits"
                 ...
                 :name => "No Doubles 1-10",
          :description => "Nice concentration game. Everyone in a circle. We will count from 1 to 10. Any player can start by saying `1`. Then any other player can say `2` and so one. If 2 players say a number at the same time we start all over again."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Ding Characters",
          :description => "This is like Ding : players play a scene. When a bell is rang, they both need to drop into a completely different character, but the scene continues. This exercise is unlikely to lead to good scenes, but it`s a great help to teach players to drop into clear and varied characters instantly."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Ding Dong",
          :description => "This is a variation on Day in the Life : pick an audience member and ask her some questions about her day. Then play that day. Every time the players `guess` something incorrect the volunteer says `Dong`. Players try to correct until they get a `Ding`. Example. Player is in bed in the morning and the alarm clock goes off: BZZZ. You get a `Dong`. Try again and alarm clock starts playing the radio. Another `Dong`. Try again and player is woken up by the neighbour drilling a hole in the wall. `Ding`. You got it. Continue with breakfast, and so on."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Director's Cut",
          :description => "A normal improvized scene is played. At any moment a player not in the scene (or a player dedicated to this particular role) stops the scene ( see Cut ) and has the actors replay the scene with different emotions, characters, roles. Like a director instructing actors on how to play."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Disc(2)",
          :description => "Imagine the stage is a large disc, supported in the middle. The goal is to keep the disc balanced. Game starts with a player entering the disc; he is the leader. As soon as the leader stops milling about on the disc, another player must jump in and restore the balance. The new player becomes the new leader, and the previous leader becomes a follower. As soon as the balance is restored, the leader can start walking around; the other player stays where he is. As soon as the leader stops again, the follower(s) move and restore the balance. After that, the leader becomes one of the followers, and a new leader jumps in. The group of followers may split into groups of equal size, and restore the balance that way. Keep in mind that followers don`t start moving until the leader stops."
    },
    {
             :see_also => [
            "Malapropism"
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Do Ron Ron",
          :description => "4 players sing a improvised song about a subject, given by the audience, on the tune of Do Ron Ron. n"
    },
    {
             :see_also => [
            "Doo Wop(2)"
        ...
        :also_known_as => [],
                 :name => "Doo Wop(1)",
          :description => "This is another structured song format, sung as a 1950`s doo-wop. It can be structured in various ways. Here`s one in 5 beats: ask for an object. Then n Lead singer sings verse about the object All sing Chorus, in the style of I love my (object) Verse 2: explain how you found your object (all) chorus on how you love your object Verse 3: That fateful night ... explain how you lost your beloved object. This can be done as a parlando (i.e. you speak to the music, rather than sing) (bridge) Explain how bad you miss your object (all) chorus on how you miss your object Verse 4: explain how your replaced your object by a new (or other) one (all) chorus on how you love your new object (finale!) Feel free to drop e.g. the first of second chorus if you feel it drags you down. Feel free to modulate after the bridge, or not."
    },
    {
             :see_also => [
            "Doo Wop(1)"
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Double Opening",
          :description => "2 players each make a (strong) opening sentence, at the same time. After that, adhering to both openings, find the scene that makes sense for both."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Dubbed Movie",
          :description => "2 or more actors play a scene, but they don`t speak, although they can move their mouths as if they are speaking. 2 or more players sit in front of the action, and provide the speech. The effect is (or should be) like watching a dubbed movie."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
          ...
          :description => "Invent a name for a non-existing but simple children`s game. As soon as you call out the name, all players start to play the game. They can use sounds and gibberish, but no real language. See if the group can come to playing along the same rules."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Ducks and Cows",
          :description => "Great silly physical warm-up. Everyone closes eyes and trainer divides the group in 2 subgroups. Tap on right shoulder makes you a duck, and tap on left shoulder makes you a cow. Then eyes are opened and on the \"Go\" sign both groups try to find each other, by quacking & mooing."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "DVD Special Edition",
          :description => "Start off with a trailer, narrated by one of the players, followed by some quick scenes, maximum 5 lines per scene. Then show the cast (every character in the movie), and follow with the whole movie. This can be done with out without director. After the movie you can do the special features. You can do deleted scenes, bloopers, you name it. A nice format for those transitioning from short form to long form, as the start of the performance is a bunch of short scenes."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Elephant",
          :description => "This one is like an extended version of Bippety Bop(1) . Start with 3 things: an Elephant, consisting of a trunk, made by the middle player, by holding your nose with one hand, and extending your other arm through the arm that holds the hand that holds the nose (does this make any sense?). The neighboring players each form a big ear, using both arms. Don`t forget to attach the ears to the elephant`s head. Make an elephant sound. A palm tree: the middle player is the tree, her neighbors become the waving leaves of the tree. Make windy noise A car: the middle player holds the steering wheel, the neighbors do the wheels. Make car engine noise. One player in the middle. Point to a person and yell Elephant (or Palm Tree, or whatever was agreed). Then choose another player and yell something else. Do this at high speed. Now for the extension: when someone makes a mistake, look at what the person does, and add that to the list of possibilities. For example, someone might be waving their arms incorrectly in from of them, trying to build the trunk of the elephant. If the group things this resembles, say, a swimmer, we decide on adding a swimmer to the list of options. Say the middle player does the arms and her neighbor do the legs. Repeat until you have so many options that everyone goes wrong..."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Emotional Family",
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "Players in pairs, facing each other. One starts talking in gibberish, with a specific emotion (angry, happy, in love, you name it). The other instantly copies the emotion of the first player, and speaks in his own gibberish. No need to try and copy the other player`s gibberish, and both players keep talking, no pauzing allowed. After about 10 seconds, the second player changes emotion, and the first one immediately follows her."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Emotions Characters",
          :description => "Players in pairs, arms loosely hanging (not folded, not stuck in pant pockets). Players look at each other with pity. No words or sounds allowed, and no use of hands. Ask everyone to change partners. Players are asked to look at each other lustfully. Change partners again. Players are asked to look at each other joyfully. Then yell any of the three emotions. Players need to find back the partner with which they did that emotion and do it again. Repeat this several times. Then ask players to walk around the room. When they meet one of their 3 partners, they return to the look that went with that partner. In between partners they stay neutral. You can try more or different emotions, of course."
    },
    {
             :see_also => [],
           :variations => [
            "Occupation Endowment: One player leaves, the audience gives an occupation, and this player need to be endowed with that occupation. Game is over once the occupation is guessed.",
            "Murder Endowment: Audience provides a location and a murder weapon (and perhaps an occupation for the victim as well). Player that was sent out needs to guess these",
            "Object Endowment: Audience provides 3-5 objects. Players try to endow the other player to use those object",
            "Secrets Endowment: 2 players. Audience provides a secret for both; players do not hear their own secret but know the secret of the other. Then they try to endow the other players with their secrets",
            "Superhero Endowment: Audience provides a new brand of superhero. E.g. toothbrushwoman. Audience also provides 2 strengths and perhaps 1 weakness for this superhero. Others try to endow player one with the name, strengths and weakness of the new brand of superhero"
        ],
        :also_known_as => [
            ...
            "Superhero Endowment"
                 ...
                 :name => "Endowments",
          :description => "This is a general handle for a ton of endowment games."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Energy 1-10",
          :description => "Everyone in a big circle, squatting down. We will count 1 to 10, all together, moving up, with increasing energy level. 1 is hardly audible, 10 is as loud as possible, everyone standing straight, hands reaching up. It`s important to watch each other, to ensure we`re all at the same energy level. Also make sure that the increase in energy is nicely gradual."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Evil Stick of Gum",
          :description => "This is a variation on Little Voice . In this game one character has a piece of gum in her mouth, and this piece of gum is capable of talking. The point is that other characters in the scene do not know about this piece of gum, and hence mistake the gum`s words for the characters. Since our piece of gum is evil, it tries to get it`s owner in trouble."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [
            "Exit Game"
                 ...
                 :name => "Walkout",
          :description => "You need at least 3 players for this one. Give each player a word. Start playing a scene with 2 players. As soon as a player hears her word, she has to leave the scene. As soon as she hear her word again, she needs to walk into the scene again. Walkouts and re-entrances need to be justified."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "MC asks the audience for famous (living or dead) people, or characters in movies, cartoons or songs. Players line up and invent `famous last words` for the subjects given by the audience."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Famous Person Endowment",
          :description => "1 player gets a number of famous persons; one for each other player in the scene. Then a scene is played with all players, and player 1 endows the others with the personalities given by the audience. Sort of the inverse of The Party ."
    },
    {
             :see_also => [
           ...
           :variations => [
            "You can introduce this in a fairly simple way, by asking the players to move about the room, according to directions or orientations: be a `horizontal` or `vertical` person be downward, or upward be light or heavy Then experiment with these: be suddenly light (bird taking off from a tree) or continuously light (be a cloud). You can do this using different kinds of music. What direction / weight / movement does a certain song or theme inspire? Then try to experiment with characters: who or what would be vertical person be (a general?). What/how would be continuously light person be (stoned?). Suddenly light (flirty?)."
        ],
        :also_known_as => [],
                 :name => "Fast Food Laban",
          :description => "Laban was a movement theorist, and this exercise is based on (a simplified form of some of) his ideas. Take 3 categories: Timing: Sudden or Sustained Weight: Heavy or Light Space: Direct or Indirect Then try and make characters that behave/speak following combinations of the 3 categories: punching : sudden / heavy / direct slashing : sudden / heavy / indirect wringing : sustained / heavy / indirect stroking : sustained / light / indirect dabbing : sudden / light / direct smoothing : sustained / light / direct pushing : sustained / heavy / direct",
                :notes => [
    ...
    },
    {
        ...
        :also_known_as => [
            "Rewind"
                 ...
                 :name => "Fast Forward",
          :description => "For this handle we need a `director`, or the MC can take on this role. A scene is started. The director can at any point interrupt the scene, and fast-forward (or backward) to another point in time. The story is then continued in that time. This technique can create flash backs."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Final Freeze",
          :description => "This is an extension of Blind Freeze : players try to do callbacks from previous scenes in the Freeze. Recycle characters, situations, or even continue scenes that were frozen before."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Finger Applause",
          :description => "Have the audience clap not their hands, but start with 2 fingers. Then gently add more fingers until the whole hand is used."
    },
    {
             :see_also => [
            "Blind Lead"
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Five Things",
          :description => "One player leaves the stage while the Host asks for an everyday activity. Then, audience and host will change 5 things about that activity. Example: suggestion is feeding the cat. One might change the following: change the cat into something else, say a tiger change the verb into some other verb, say deep frying change the location from where one might feed the cat. Say the Vatican. change the character. Say character changes from cat-owner to postman add interaction with a famous person, say Elvis. After that the 1st player is brought back in and a scene is played in Gibberish . The other players have exactly 5 minutes to make the first player guess each of the five things. Depending on the original suggestion, feel free to change whatever."
    },
    {
             :see_also => [
            "Aerobics"
           ...
           :variations => [
            "One option: The top player bumps into the last line, and takes over their movements."
        ],
        :also_known_as => [],
                 :name => "Flock Dance",
          :description => "This is a physical warm-up. The group forms a pyramid: one player becomes the top, 2 players behind her, 3 players on a third line, and so on. The top player starts moving about the room (perhaps use music to guide the players). The second line follows the first player, and mimics her movements, and the third line follows the second line. The top player can alternate however she wants (and can be guided with e.g. a change in the music). The top player can even turn around, and face the second line. Confusion will be complete. Other"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
          ...
          :description => "All but one in a circle, one player in the middle. The middle player closes her eyes, and the rest of the group quietly chooses a leader. Middle player opens her eyes and tries to find the leader. The whole group follows the leader, in everything he does. As soon as the middle player finds out who the leader was the game is over. This only works if movements are clear, not too fast, and if the group `follows the leader` as fast and as precisely as possible."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [
          ...
          :description => "Silly physical warm-up. Have everybody mill around the room, and shout a body part. Players then start moving around as if they are leaded by that body part. Continue with another body part. End the game on a really silly note by leading with e.g. your internal organs."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [
            "Subtitles"
                 ...
                 :name => "Foreign Movie",
          :description => "2 players play an improvized story in Gibberish , 2 others translate. The idea is to build the story together: the `actors` give elements to the translators, and the translators can help steer the action for the `actors`."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Fortune Cookie",
          :description => "Open a fortune cookie, read it aloud. Then improvize a scene based on the fortune."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Fortune Teller",
          :description => "One player covers his ears while the others get `predictions` from the audience; one prediction per other player. First player then plays a fortune teller who must be endowed by the others to predict the given predictions."
    },
    {
             :see_also => [],
           :variations => [
            "and see other games in the Association category. The Basics In a free association we will ask players to say the first thing they think about when hearing (or seeing, feeling, smelling or tasting) anything another player provides. It should be stressed that anything is valid, as long as it is not preconceived: the association should be based on what the previous player has offered.",
            "Here is are list of Free Association games: n Free Association Circle Free Association Lines Walk-over Association Word Ball Firing Squad"
        ],
        :also_known_as => [],
                 :name => "Free Association",
          :description => "This is the classic association exercise. There are various ways of playing this (see"
    },
    {
             :see_also => [
           ...
           :variations => [
            "Try this in combination with Last Letter.",
            "See Blind Association Circle for another variation."
        ],
        :also_known_as => [],
                 :name => "Free Association Circle",
          :description => "Everyone in a circle and we establish a rhythm, by swinging a hand. Once a rhythm is established, one player starts by tossing a word to his neighbor, who associates on the word and tosses another word to his neighbor. It`s important to stay in the rhythm. Tell the players to just say `banana` if they feel they can`t think of a word, as long as the rhythms does not get broken."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Free Association Lines",
          :description => "Yet another way to play association games. Place all players on 2 lines, facing each other. One player starts walking to another player in the other line. Just before he gets to that other player, he throws her a word. The receiver starts crossing the line towards someone else, and the first player takes her place in the line. The receiver now becomes the thrower, throwing the first word she can think of to another player, who then starts walking, and so on."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Free Falling",
          :description => "Nice, but a bit dangerous exercise to build trust. In it`s simplest (and safest) form all players stand in a circle, one player in the middle. The player in the middle closes her eyes, slowly turns around, and then lets herself fall backwards (or forwards). The other players need to catch her."
    },
    {
             :see_also => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "French Braid",
          :description => "This is a very simple format, which consists of a number of (unrelated) scenes, that get interrupted, and then continues at a later point. It is played as follows: 2 or more players start a scene. At any time, when another player or players enters the stage, the scene is interrupted (or fades out) and the new player(s) start a new scene. This is repeated until all players nhave played. Then the series is restarted with the first scene. This scene continues, or starts at a later point in time (or later in the story, like a Fast Forward ). The scene gets interrupted again, and so forth. The whole is repeated several times. This is typically played without a director - the players decide when to interrupt an ongoing scene. Players typically play one character."
    },
    {
             :see_also => [
            "Group Environment"
        ...
        :also_known_as => [],
                 :name => "Front Desk",
          :description => "We improvise a scene, set in the lobby of a hotel. One or more players play the receptionist(s) and the others play guests arriving or checking out, bell boys, repairmen, you name it. Players construct the environment together - as soon as a door, a plant, a desk or whatever is `placed` by any player, all other players should respect it."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Fruit Basket",
          :description => "must leave her chair and find another chair. Person that doesn`t find a chair becomes the next in the middle. When `Fruitbasket` is called, everyone changes chairs."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Fusillade",
          :description => "Great exercise in fast thinking, but seen done in performance as well. Would be an excellent challenge for a theater sports match! All players line up in 2 lines, facing each other. MC or trainer yells a word/title, and next player in line gets 30 secs to do his or her thing, based on the suggestion. After 30 seconds new title/word is given and next player goes."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Game-O-Matic",
          :description => "This is like `invent-your-won-game` : ask the audience for the name of an unexisting improv game, then invent the rules on the spot, and play it. Kind of risky, but if the group has been playing short form improv games for quite a while, coming up with rules is easy."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Gibberish Commands",
          :description => "Another exercise on Jabbertalk : players in pairs. Have each play issue a command to her partner, in Gibberish. Players can`t move on until the command is understood and executed. Simple things will do, like `pass me the salt, please` . The idea is not to mime the command, but to try and make it obvious for the way the command is issued, and the environment that has been set."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
          ...
          :description => "One player is an expert on a subject, often provided by the audience. Furthermore, he`s from a foreign country (perhaps also supplied by the audience). The expert gives a lecture in Gibberish and a second player translates."
    },
    {
             :see_also => [
            "Malapropism"
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Gibberish Malapropism",
          :description => "This exercise flexes your mind and is a good exercise for Gibberish games. Have the players walk about in the room, point to any object, and give it another name in Jabbertalk ."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [
            "Gibberish Dictionary"
                 ...
                 :name => "Translate Gibberish",
          :description => "This is best played with an odd number of players. Everyone in a circle. The first player gives a gibberish word to her right neighbor, who translates the word. The next player provides the next gibberish word, and so on."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Give and Take",
          :description => "This is a variation on Walking by Numbers : all players find a position the room. One person must always make sound and one person must walk. This can be the same person who is walking and making sound but it could be one person walking while a different person is making sound. The focus can be given (i.e. a walker stops walking) or can be taken (i.e. someone else starts walking; the original walker must stop then). Feel free to try with multiple walkers."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Goalie",
          :description => "Great high-tempo exercise. 1 player up front. He`s the goalie. The other players all think of an opening line for a scene, and a character. When everyone has their opening line and character, we bombard the goalie with these offers, one at a time. Goalie needs to react right away to an offer, acknowledging the opening and character, snap into an opposite character and reply to the opening. Immediately after that the next player comes up with his or her offer. This exercise is good for teaching players to react right away, and to snap into a character almost without thinking."
    },
    {
             :see_also => [
            "Voices from Heaven"
            ...
            "This is a great way of exercising monologues! Referring back to the work of Masters, many groups tend to end the format with the death of (one or more of) the character(s)."
        ],
           :variations => [],
        :also_known_as => [
            "Spoon River",
            ...
            "Spork River"
                 ...
                 :name => "Goon River",
          :description => "This is a improv format that consists of monologues. The story is not played, but told. The players (typically 3 or 4) line up in front of the audience, Based on a single audience suggestion they all tell the same story, each as their own character in that story. The play usually starts with every character introducing him or herself. The order in which characters speak is not really important, as long as they all speak. After the introductions, things start to happen. Every character reflects on what is happening from their own perspective, and each character adds elements to the story. Keep going (and make sure that every character keeps contributing) and r Reincorporating as long as things stay interesting."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Gorilla Theatre",
          :description => "This format is played with 3 experienced players, one MC and another player, dressed up as a Gorilla. The Gorilla is the prize to be won; the best player of the evening gets to spend a week with the Gorilla, and of course this is quite a privilege! The Gorilla enters with last week`s winning player (real or faked). The MC explains that the score for the evening will be counted by means of bananas; the player that end up with most bananas at the end of the game wins another week with the Gorilla. The audience is trained to `vote` by yelling `Banana` (for a good performance) or something else, like `Die` or `Forfeit` for a bad performance. Each scene is then played by 2 players, and directed by the third. The beauty of it all is the fact that not the players are judged by the audience, but the director. Players take turns directing, and after each game the audience either awards the director a banana, or a forfeit. Bananas are pinned on a scoreboard, or pinned onto the winning player`s costume - cardboard bananas are preferable in the latter case. A forfeit is like a punishment for a poorly directed scene. Possible forfeits might be calling your mom and explaining why you`ve been such a lousy director, or having to sing a song about your bad scene. The director gets to choose the scene or the game to be played. Perhaps a list of games to be played this night is on the stage, and directors can write their names next to the games they want to direct. The director directs the scene, gives players side-coachings, can interrupt the scene, introduce tilts or make the players repeat (part of) the scene. To ensure that bad scenes don`t drag on forever, or to prevent directors to play tons of 30-second scenes in order to improve their chances, certain troupes limit the amount of time for directing to like 20 minutes per player. This format can be played with or without attributes and props. The Gorilla might even be used as a prop, or even as a player, although the Gorilla should not try and steal the show. The Gorilla is a player, so he too should be prepared to take risks, and he`s supposed to be naughty. This is a fairly advanced format, as the players not only need to play well, they also need enough insight to effectively direct scenes. This is also a rather nice format, as players are not rewarded; 2 players playing well together generate a banana for the director, and this way the format prevents competition between the players. Origin Attributed to Keith Johnstone , and described in Impro for Storytellers ."
    },
    {
             :see_also => [
            "CD Shop"
        ...
        :also_known_as => [],
                 :name => "Greatest Hits",
          :description => "This game was made famous by the TV show \"Who'se line is is anyways\". Typically played with 4 players. 2 of these are the hosts of a tv commercial, trying to sell a CD compilation of 'greatest hits'. Audience suggestion is the theme of the CD. E.g. a profession: \"accountants\". The CD to be sold is then \"Songs for Accountants\". The hosts discuss the CD, why viewers should buy it, and select 3-4 tracks. Each track gets a title and a style, e.g. (for accountants) \"The IRS blue\" - which in this case also implies the style. The other players then improvise that song, in that style. For examples, do a search on youtube for WLIIA Greatest Hits."
    },
    {
             :see_also => [
            "Presents"
        ...
        :also_known_as => [
            ...
            "Lost Friend"
                 ...
                 :name => "Greetings",
          :description => "All players start milling about the room. You then ask them to greet each other, perhaps just by shaking hands. Players just shake hands, move on, and greet the next player they meet. Then ask the players to greet each other in a more specific way. Possibilities are: greet each other like you greet a long lost friend greet someone you don`t really trust greet an ex-lover greet someone you really hate someone you have a secret crush on someone you had a one-night stand with someone that sold you a crappy used car someone with bad breath greet someone like you are a cowboy, a soldier, a nanny, a Russian farmer,..."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
           ...
           :variations => [
            "Let all players make noises, hum, whistle as they mill about. The noisier, the more challenging the exercise becomes."
        ],
        :also_known_as => [
            "Statues"
        ],
    ...
    },
    {
           ...
           :variations => [
            "Do this with the whole group: everyone in a big circle, and everybody mirrors everybody else."
        ],
        :also_known_as => [
            "Group Mirror"
        ],
                 :name => "Mirror",
          :description => "Players per 2, facing each other. They can move (arms, legs, eyebrows) slowly, and the other player will mirror them. This is a game of give and take - no-one should be (continuously) leading. Keep movements slow."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Hand Slap",
          :description => "All players in a circle, down on the floor. Cross arms, and then put hands flat on the ground. Each hand in turn pats/slaps the ground, in order. Hands that miss are eliminated."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Handicapped Fairy Tale",
          :description => "Very silly but very effective. Ask the audience for a fairy tale. Then give every player one or more characters in the story. Ask for a handicap or peculiar state of mind for each character and improvise the fairy tale."
    },
    {
             :see_also => [],
           :variations => [
            "Squeezes can run in different directions, and you can have more than one squeeze wave cycling through the circle at a time Instead of squeezing, you can make players communicate by pressing (or even slapping) hands together Squeezes can run at different rates - this can be controlled by letting nobody squeeze their neighbors as long as the squeeze they receive is not over yet You can have one player try to `detect` the squeeze (try and squeeze as unnoticeably as possible)"
        ],
        :also_known_as => [
            "Hands"
        ],
                 :name => "Squeezer",
          :description => "Get everyone into a circle, holding hands. One player starts the game by squeezing the hand of one of his neighbors. The receive then squeezes the hand of his other neighbor, thus generating a `squeeze wave` through the circle."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Hats",
          :description => "A very silly game. 2 improvisers put on hats, preferably similarly sized. Scene ends when one player grabs the other player`s hat or tries to do so and misses. Any grab, move to grab or defensive movement needs to be fustified. Try and play the scene for reality."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Heave Ho",
          :description => "This is like an extended version of Tossing to be played with 16+ players. All players but one form 2 lines, facing each other, and link hands to form a platform, which is used to heave the last player from one end of the line to the other. Best to remove shoes, coins, and any other objects that might fall or hurt someone."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Hesitation",
          :description => "In this game a scene is played, in which at any time, any player may `hesitate`, and ask the audience for help. Anything provided by the audience must be justified and incorporated. Examples: James, hand me that .... (signs the audience for a word) -- Lollypop. Ah, I was sailing the 7 seas in my .... Newspaper. Yes, Newspaper, finest vessel ever built by ..... (martians)"
    },
    {
                :notes => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Horoscope",
          :description => "Take a magazine with a horoscope. Ask an audience member for their birthday, read their horoscope and then improvise a scene based on that horoscope. Can be combined with Day in the Life ."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "House, Creature, Flood",
          :description => "Players form a house, in which one other player is a creature. When trainer calls \"house\" the house players make a new house over the creature. When trainer calls \"flood\" everyone moves about and finds another position."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Human Knot",
          :description => "Have the players stand in a tight circle, with their hands in the center. Then have them grab other hands at random. The puzzle is for the whole group to work together to get themselves untangled. Sometimes youâ\u0080\u0099ll find that the group has actually formed several smaller circles."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "I Love You",
          :description => "A simple song structure for 2 singers. Singer 1 sings 4 lines; the first 3 are about the other character; line 4 is simply \"I love you\". Then player 2 does the same about the first character. May rhyme but that`s not a must. After that, the 2 parts are repeated, but interweaved, one player at a time, and ending, singing together, with \"I love you\". Example: Player 1: You sing so well, You dance so great, You act so fine, and I love you Player 2: Your voice is so deep, your lips are so full, you move with grace, and I love you Interweaved: You sing so well (player 1), Your voice is so deep (player 2), You dance so great (1), your lips are so full (2), you act so fine (1), you move with grace (2), and I love you (together) r"
    },
    {
             :see_also => [
            "Day in the Life"
        ...
        :also_known_as => [],
                 :name => "ID",
          :description => "Ask a number of Ids, driver`s licences from audience members. Improvise a scene in which the ncharacters are based on the Ids. The host may ask these folks questions about their lives."
    },
    {
             :see_also => [
            "Opposite Characters"
        ...
        :also_known_as => [],
                 :name => "Imitate",
          :description => "This is an exercise for characters. 2 players will play a scene in a shop. The quality of the scene is irrelevant here, really; just get into the shop, order what you need, pay for it and off you go. Give us an object (a carrot) and we got a scene in a carrot shop. One player is designated as shopkeeper, and the other will play the customer. The idea is to give the `customer` a basis to build a character. She will enter the shop in that character, and the other player (the shopkeeper) tries to imitate the character as closely as possible. Use the following tricks as stepping stones for building characters: Ask `customer` to talk to you in different voices. Pick one of these and there she goes. Ask the `customer` to pull different kinds of faces. Pick one and there she goes. Pick a body part (elbow). There she goes; taking the suggestion `elbow` as inspiration for her character. Pick an emotion and there she goes. Ask her to move around a bit, dance and let her freeze. The position in which she is frozen is her inspiration for the customer character. This is an exercise for both players, but what is exercised is different for both: for the customer, the exercise is building a character out of a silly suggestion. Note that there are not good or bad characters; anything in the position/suggestion given to the player can be used as inspiration, even if the `link` between the suggestion and the actual character is not obvious. The only goal is to come up with interesting, strong characters. for the shopkeeper this is a listening/watching exercise. The idea is not for the shopkeeper to build a character based on the suggestion; it is for him to imitate as closely the character treats of the customer."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Impro Match",
          :description => "This format does not have a specific name and is mainly popular in French speaking countries. There seem to be leagues in just about every French speaking country; there`s even a league playing this format in the Congo! These leagues meet every year to play a world championship. The format is modeled after an ice hockey match: 2 teams of 6 players, 3 men and 3 women, perhaps with one coach per team play each other during 3 30-minute rounds, in a `ring` resembling an ice hockey field. The game is lead by a referee and 2 aides. The referee draws challenges out of a bin; challenges can be mixed or separated. A mixed improv scene is played by players of both teams; a separated scene is played twice, each time by players from one team. Challenges consist of: Title for the scene: can be anything Number of players per team: can be unlimited, or specified. In some countries they may even specify the genders, like `2 females for the red team, unlimited for the blue team` Category: might be anything, but examples would be Science Fiction, Drama, Dostojewski, Western, Musical, Opera, Without words or Without sound, or To Be Continued. For the latter one, the scene played by the first team is to be continued by the second team Duration: a number of minutes, ranging from 20 minutes to 30 seconds During the improvisation the referee walks though the scenes, and blows `faults` on a whistle. Possible faults would be: Dragging (slow play), Invalid number of players, Violation of the theme (or title), Confusion, Obstruction or Foul Play, Blocking, etc. Every fault is indicated by a particular gesture. When entering the theatre, the audience receives a `fault card` explaining which gesture indicates which fault. Fault can be awarded to an entire team, or to individual players. When a team collects 3 faults, the other team receives an extra point. r When a player collects 3 personal faults, he or she is expelled from the game for 5 or 10 minutes. Every member of the audience also receives a slipper. This can be thrown into the ring when the audience doesn`t like a scene, or even better, at the referee, whenever he or she makes an unpopular decision. After each round the team captains may ask the referee for an explanation on the faults that were blown, and then the audience gets to vote. Every team has a color, and the audience gets colored cards to vote with. After 3 30-minute rounds we know which team won the match. Finally, a celebrity or local hero gets to award `stars` to the 3 best players. This is a very rigid format, in which just about anything, except the scenes themselves, are fixed. There is a whole protocol to be followed to play a match, and even the number of separated and mixed scenes is set in stone. The idea is that the rigidity of the format contrast well with the anything-is-possible con"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "In-Out",
          :description => "Every player gets a word from the audience. When that word is said by any player, this player must leave the scene if he`s in it, or enter the scene if he was not in it (yet). Entering and leaving the scene must be justified."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Introducing Association",
          :description => "This little technique can be used to show a new group how natural associating really is. You can only do this with a new group, that has not played any association games before. Place all players in a circle. Ask one player to say a word, no matter which one. The player to her right then says no matter what word, and so on. Do not tell them they should try and `associate`. You (and hopefully the group) will notice that patterns of `related` or `associated` words emerge. Use this as an introduction to show how natural associating is to humans, and then proceed with the other association games."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Invisibility",
          :description => "Scene in which one one of the characters in invisible to the audience. Characters act and behave as if this invisible character is visible to them."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Invocation",
          :description => "This is a kind of Opening for Long Form . It goes in three steps. Get a suggestion from the audience. Then this suggestion is praised by each player in turn. Same suggestion is praised again, but now Endowing with human attributes, naming the `suggestion` as humans. Expand the language to something. Go poetic, gibberish-french, whatever. After that, the players take on the characters that evolved during the previous rounds. Then, the Long Form is played using those characters."
    },
    {
             :see_also => [
    ...
    },
    {
        ...
        :also_known_as => [
            "Jeepers Peepers"
                 ...
                 :name => "The Scream",
          :description => "Everybody in a circle, watch the ground. On your sign, everybody lifts their head and either looks straight, left or right. Whenever 2 people look each other in the eyes, they scream as loud as they can, as if they`re startled, and then drop dead. Repeat till only one or 2 players are alive."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Jeopardy",
          :description => "This games is not unlike Worlds Worst : have the players close/cover their ears. Then ask the audience for questions and answers. Examples would be: What is the color of an American school bus? Yellow. What is dyslexia? Not being able to make words out of letters. Write down the answers, not the question. Then give the players an answer and let them come up with questions that might be answered correctly by that answer. It`s kind of like `what would the worst/sillies/funniest question be that could have this answer?`"
    },
    {
             :see_also => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Killer Bunny",
          :description => "This is like Bunny except that at any time, the middle bunny is allowed to lift her hands above her head, lunge to either right or left side and eat one of her own ears, after which the ear player would be out. However, any other player in the circle can prevent any ear from being chewed by yelling Die while bunny`s arms are up in the air, in which case the middle bunny would be out. Silly, indeed."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "King Lizard",
          :description => "Everyone in a circle and picks an animal, a motion and a noise for that animal. One person \"sends\" the action to another person by making their own noise/motion, and then someone else's noise/motion. That person, in turn, makes their noise/motion, and then another person's. Cat, monkey, and dog are commonly used, but creativity is encouraged...the sillier, the better! If someone \"messes up\", they're out for that round. Last person still in is the winner."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Kitty in the Corner",
          :description => "Classic children`s game. 4 to 6 players stand at corners of the playing area, one player in the middle. 2 players try to make eye contact, and then switch places, while the middle player tries to capture a corner. The faster the pace, and the higher the stakes (make diagonal eye contacts!) the more fun."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Knife Baby Angry Cat",
          :description => "All players walk around the room. Start by one player pantomiming throwing a knife, ninja-style, to another player. That player catches the knife and throws it to another player. Players should have eye contact between thrower and catcher before the knife is thrown: it should be very clean who is supposed to catch the knife. Once that goes well, add a pantomimed baby, which gets thrown very carefully. Give the baby a sound that is clearly distinguished from the knife. Finally, add in an angry cat. Again with distinct sound. Feel free to add other objects but make sure throwing style and sound are different."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Ksss",
          :description => "Nice warm-up, easier to play than to explain. Players in pairs. Establish a beat (by slapping your thighs). Once beat is established every player has the choice between 4 different movements: Move both hands up Point both hands left Point both hands right Point both hands down So, every beat goes like, slap, point, slap, point and so one. Except, when the 2 players happen to make the same movement (i.e. in the same direction) then after the next slap they both make a 5th movement: point both hands towards the other player, miming a gun, and say `psssst`. Next beat they do what they want again."
    },
    {
                :notes => [
            "Also known as Rashomon after the movie by Akira Kurosawa, that follows different points of view as well. For the same reason also known by the name",
            "The technique can be used as an excellent Narration Exercise : have one improviser tell a story, something simple like what happened to him or her today, interacting with other characters. After that, other players talk about the interaction from the POV of one of the characters in the original."
        ],
             :see_also => [],
           :variations => [],
        :also_known_as => [
            ...
            "Kurosawa"
                 ...
                 :name => "Point of View",
          :description => "Improvise a simple scene. Then the scene is replayed, from the point of view of one of the characters. You can replay several times, from several POVs. Make sure the scene is such that the relationships between the characters allow for clear POVs. A scene about dryly buying a pair of shoes does not lead to exciting POVs..."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "La Ronde",
          :description => "This is another Long Form improv format. The name is based on a novel by Arthur Schnitzler, called Traumnovelle, in which a series of characters sequentially bed each other, from first to last back to first. The format is fairly simple: we play scenes in which at every scene switch, the `oldest` character disappears and a new scene is played with the remaining character, and a new one. The form ends when the circle closes and the last and first characters do a scene. Obviously, there is no need for all characters to bed each other! Switching scenes is done by tagging out (like in Freeze Tag ). The idea is to see different aspects of a character, in different situations, interacting with different characters. For a long discussion about the format see Chicago Improv ."
    },
    {
             :see_also => [
           ...
           :variations => [
            "Try in combination with Walk-over Association or Word Ball."
        ],
        :also_known_as => [],
                 :name => "Last Letter",
          :description => "This is an Association game, where instead of naming the first word you think of upon hearing a previous word, you name the first word you think of starting with the last letter of the previously heard word."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Last Letter Scene",
          :description => "A scene is improvized, in which every next line spoken needs to start with the last letter of the previous line."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Leave for a Reason",
          :description => "This exewrcise is done without speaking. All players mill about the room, and, as a group, find a reason to leave the room. All players should leave at the same time, and the reason should be obvious to all players. Great exercise to train group agreement."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
             :see_also => [],
           :variations => [
            "Feel free to pass other things, each with it`s own gesture. Possibilities are: months of the year; notes (like `do`, `re, `mi`, ....)"
        ],
        :also_known_as => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Line Mirror",
          :description => "This is an extension of the Mirror game. Have all players line up in two face-to face rows, about three feet apart, holding hands (within a row). All players can slowly start moving, but keep holding hands, and all movements get mirrored by the other row."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Location",
          :description => "Get a location (say the Post Office). The whole long form is played in one and the same Post Office. Different characters wander in and out, you can even do time shifts and playbacks, but the environment of the scene is limited to the location given."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Lotus",
          :description => "This is just a series of scenes in which each new scene evolves out of the dynamics of the previous scene. Divide the stage in 3 playing areas. Put at least 2 players in each area. Then in each area a scene is played. The first group starts with nothing. As soon as the second pair or group understands the dynalics of the first scene, they start theirs. Ditto with the third group or pair. This is done 3 times, to yield 9 scenes. Every time a group or pair starts a new scene, the previously created characters are used again."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Lounge Singer",
          :description => "Ask for an unlikely place to find a lounge singer. One player improvizes a solo song, Frank Sinatra style. You`ll get something like \"Welcome to the pediatrician`s Office\". Great opener!"
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Machines",
          :description => "MC/trainer comes up with a (real or invented) machine. The players make the machine; every player becomes a part of the machine. We want to see/hear the machine work."
    },
    {
                :notes => [
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Marriage Counsel Endowment",
          :description => "One player is sent out of the room while the host gets 2 relationship problems from the audience. 2 other players play a couple with these problems, and player one is the therapist. Players need to get the therapist to figure out what the relationship problems are."
    },
    {
             :see_also => [
            "The Gerbil"
        ...
        :also_known_as => [
            "Chubby Bunny"
                 ...
                 :name => "Marshmallow Mania",
          :description => "Improvise a scene in which the audience is not supposed to laugh. Any player who provokes a laugh, gets a piece of marshmallow in his/her mouth. Players are allowed to chew, but may not swallow."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
          ...
          :description => "Begin with 2 players, each on a chair. In character they start to talk about what happened to them in the past. Players take turns talking. Then follows a series of scenes, and for every new scene location the chairs are moved. When returning to a scene location played before, return the chairs to the position they were in in the original scene in that location. End with the 2 chairs back front stage, as in the beginning of the play. At the same time (of course) conclude the whole story. Usually played with 2 players, but more is possible. Origin Attributed to Dan Goldstein."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "2 players, one is the master, the other is the servant. The master will ask the servant for something simple. The servant always blocks the question, and explains why this should not be possible. The master always accepts this, and asks for something else (which turns out to be impossible as well). Every time the servant has to explain why this should not be possible, the situation gets worse, until the whole thing turns out to be a disaster. An example: Perkins, get me a glass of brandy. Yes sir. Oh, sir, that won`t be possible sir, we`re out of brandy. Well, get me a glas of whisky, then. Yes sir. Ah, sir, um, we`re out of whisky too, sir. Oh? Well get my any kind of alcohol, then. Ah sir, we`re out of alcohol sir. Perkins, have you been drinking again? Well, the staff had a little party last night, sir. I see. Well get me a glass of water from the kitchen then. Yes sir. Ah, sir, the water pipes are bust sir, sorry. Well, get me some water from the pond then. Ah, yes, sir, uh, sorry sir, the pond is dry, sir. And so on, until it turns out that the staff had a little party, accidentily set the kitchen on fire, used the water from the pond to fight the fire, and so on. Eventually, the only room still standing is the master`s study, the rest of the castle has burnt down and all staff are dead. And all this for a perfectly logical explanation. The idea is for the servant to connect all elements the master brings up, into one and the same disaster. In this respect this game resembles Boris."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Mega Replay",
          :description => "Divide the players in 2 groups. A scene is played by the first group from a well known story, fairy tale, historic fact. This scene nis then replayed by the other group, in a different emotion, age or style. After that the first group replays as well, again in different emotion, style or age. You can repeat this several times. See other replay games like Scene Replay and Replay Gibberish ."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Mexican Name Wave",
          :description => "Players in a circle. Let them do a Mexican Wave: one player lifts both arms in the air, and down again. When his arms are totally up, his right neighbour starts doing the same, so a `wave` of hands circles around the circle. When they`ve got this, at the same time, pass your name around the circle, going the other way. Names are passed by pointing to your left neighbor and saying your name. Confusing, indeed!"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Micetro",
          :description => "Pronounce as `Maestro`. Comparable to Gorilla Theatre , but a bit easier, and can be played with a fairly large number of players ( up to 20), and 2 directors. The names of all players are on a big score board. The directors choose for every game the appropriate number of players, perhaps by fishing name tags out of a hat. The directors explain the improv game to be played, perhaps ask the audience for suggestions, direct and correct the scene. After each scene or game the audience decides, by cheering or applause how many points the scene should be awarded. Each player gets as many points as the scene he or she played in was awarded. Once everyone has played in a scene, the players with the lowest score drop off, and the whole thing starts again. The directors ensure that (certainly with large groups of players) that there are more group-games at the start of the evening, and more 2-person scenes or even monologues toward the end of the evening. This is a fun format that can be played with mixed bunches of experienced and not-so- experienced players. Since players are immediately judged, it is perfectly possible to pitch a start player after the first round. Since this system is basically somewhat unfair, and everybody knows this, no one should take elimination too personal (well, that`s the idea anyway). For beginners it`s a nice format, as the directors will correct obvious blunders. And since all players in a scene get the same score, this format limits competition between players in a scene. Origin The (copyrighted) format is attributed to Keith Johnstone , and also described in his book Impro for Storytellers ."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Millipede",
          :description => "Great fun but be careful not to hurt each other. Make sure there are no objects along the walls of the room. All players in a circle, linking arms. Then move the circle to one of the walls, and `squash` the circle, until it becomes 2 lines, one line of players with their backs to the wall, and another line in front of the first, players facing each other. Have this whole construction wheel along the walls of the room at high speed. Tell players to be careful and not to make fists or they might slam into someone`s face."
    },
    {
             :see_also => [],
           :variations => [
            "Participants can mirror who ever they want to in the circle and shouldn't let the person they're mirroring guess that they are being mirrored. Alternatively, one player gets out of the room and waits outside while somebody is designated in the circle to be copied by all the other members of the circle. The player waiting outside is called back in and has to guess, by observing the circle, who is originating the movements that everyone else is copying."
        ],
        :also_known_as => [],
                 :name => "Mirror in Circle",
          :description => "All players in a circle. Make eye contact with the player immediately in front of you, or on the other side of the circle and start mirroring each other. Once the routine is established, they both start to walk to the center of the circle and stop when they are close enough to touch, still mirroring each other. All the players should reach the center of the circle at the same time."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Montage",
          :description => "This is just a name for the most generic form of Long Form : a Montage is just a series of scenes, connected or not."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "More or Less",
          :description => "This is a nice improv show format. Any number of players from 5 upwards. Every player takes turns presenting a scene. First player starts, asks audience suggestions if needed, and directs the scene to the extent needed. After a couple of minutes the director asks the audience: more or less. Audience yells their preference, and if More sounds loudest, scene is continued. If audience yells Less then the scene is not continued and another player presents another scene. Origin Originated at the Loose Moose Theatre in Calgary, Canada."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Motel",
          :description => "This is another variation on the classic Harold . The twist (and hence the title): all scenes happen in the same motel room. Suggestion can be anything, and the opening can be a free association. After the 3 first beats of 3 story lines are played. Anything goes, but the scenes all happen in the same motel room. They may happen in the same time frame (Kennedy-era for example) or they may happen in different time frames. After the 3 first beats, one player from each scene does a monologue, in which she reveals to the audience a secret that the other character(s) in the scene do(es) not know. Then the 3 second beats are played. Between the second beats and third beats, the other characters in the scenes reveal their secret that the other characters are not aware of. Conclude with 3 series of third beats. Origin This format is attributed to Jstar Atlanta."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Mother Goose",
          :description => "Great Status improv exercise. All payers play geese. The idea is to establish a pecking order, that is clear to all, without talking. There should be one Mother Goose and every player should have an idea who is (right) above him or her. After lots of clucking, see if the group can line up in pecking order."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Move and Speak",
          :description => "Play a 2-player scene, in which no-one is allowed to talk unless they create a new object and a movement along with it. All created objects stay where they are, and moving a previously created object does not lead to permission to talk. See Touch to Talk for a similar improv game."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Movie Review",
          :description => "4-10 players. Ask the audience for a movie title. 2 players will do an interview: one will be the reviewer. As the movie is discussed, other players play parts of the movie."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Mr. So and So",
          :description => "This is an improv game that`s more suited for rehearsal than for performance, though I can work on stage as well. Here is how it works. Players call for new characters, by giving them names that refer to character or physical traits. Things like: Ah, here comes mr. Bad Irish Accent; I think we need Mrs. Pathological Liar for this one; Dear dear, if that isn`t Sir Eats-People. And so on. The idea is to challenge the other players with weird and unexpected suggestions, and forcing htem to come up with an extravagant character right away. In a sense this is really institutionalised Pimping . Another game in which a similar pimping is used would be Supermen ."
    },
    {
             :see_also => [],
           :variations => [
            "The script for the gathering and a description of the characters are prepared before the show.",
            "A second player may become the detective's sidekick."
        ],
        :also_known_as => [],
          :description => "\n            This is a Long Form format that can be played with a large number of players. It is inspired by the Cluedo board game.\n\n            The basic idea is a gathering of many characters. Audience may provide the reason for the gathering, and audience suggestions may be used to give each player a character. One character is destined to be killed; the other characters should have reasons to kill the victim; again audience suggestions may be used for that, or you let the motives evolve as the performance develops. One player is set aside to play the detective.\n\n            The format starts with the gathering, at one point lights go out and when they come up again, the victim is dead.\n\n            Next, the detective(s) interview each of the characters (separately, though other characters may interfere during the questioning). Each character should make themselves suspect, at the same time of course denying every involvement in the murder. The characters may try and implicate other characters. Events discovered during the interviews may be played as flashbacks.\n\n            After every character has been interviewed, the detective calls all characters together, Hercule Poirot style, and discusses the motives for each character. The last character discussed is tagged as the killer.\n\n            Then lights go out, and the opening scene is re-played, lights go out, come up again, and we finally see the murder happening, by the designated killer, in slow motion.\n          ",
                 :name => "Murder Mystery"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Musical Fairy Tale",
          :description => "Requires 5-7 players, plus a musician. The asks the audience for a different musical style for each player, and then asks for an audience member's favorite childhood fairy tale. The players take turns singing the fairy tale in their individual styles. Each player moves the story forward from where the previous player left off until the story is complete."
    },
    {
             :see_also => [],
           :variations => [
            "Tell the players the bottle is red hot, and they need to throw it as fast as possible, or they`ll burn their hand. The bottle becomes extremely light, or extremely heavy, and the players act accordingly."
        ],
        :also_known_as => [],
                 :name => "My Fault",
          :description => "You need 2 plastic bottles, each with a little bit of water (not too much or they`d be too heavy). Make sure your bottles are sturdy. or everyone will get wet. Have everyone walk around leisurely, and hand 2 players the bottles. The idea is to make eye contact with someone. As soon as a player has eye contact with a player with a bottle, the bottle is thrown. If at any point the bottle is dropped, both the thrower and the receiver lie down on the floor and shout `My Fault` as loud as possible. After than, one of them picks up the bottle and the game continues. Side coaching: tell the players to take risks, to try and make eye contact with a player at the other side of the room."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Name Volley",
          :description => "Divide the class into 2 groups, maximum 6 players per group. We are going to play a mimed game of volleyball, in which every player, as they pass a ball, shouts the name of another player, who then needs to catch and pass the ball. We want to be able to `see` the ball at any point in time."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "No P",
          :description => "Players play a scene (perhaps based on an audience suggestion) but they cannot use the letter `P` (or any other letter). When a player uses a `P`, the audience screams `Die` and the player is replaced by another on. The scene continues, and the new player needs to take over the character of the player he replaces."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Non Sequitor",
          :description => "Place players in pairs, let them hold a casual conversation about their work, the weather, anything. There will be 4 signals (hand clap or blow a whistle): First signal: keep the conversation going, but behave strange, make bizarre gestures and jerky body movements second signal: keep the strange movements going, and continue the conversation in gibberish third signal: keep calm, but continue the conversation in gibberish forth signal: stay calm and talk normal"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Nuclear Bomb Chicken",
          :description => "You can do this only once with a new group. Tell them they are all chickens in a henhouse, and a nuclear bomb is about to drop on the henhouse within 30 seconds, Ask the players to play the chickens as truthfully as possible, then give them the start signal. Any chicken that shows acknowledgement of the incoming bomb, fails the exercise. Chickens have no clue what a bomb is. The goal of the exercise is to show the difference between the reality of the player and the reality of the character. Origin Attributed to Stella Adler (the only known American to study directly with Russian Master Konstantine Stanislavsky). The story goes that Marlon Brando got it and simply went about laying an egg while the other chickens went in a frenzy."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Objects",
          :description => "Divide the class in 2 groups. Give one group the name of an object, and they become, as a group, the object. Other group guesses."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "One Duck",
          :description => "Everyone in a circle. We are going to say a pattern, one word per player, going clockwise. It goes like: One Duck, two Legs, Quack Two Ducks, four legs, Quack Quack Three Ducks, six legs, Quack Quack Quack And so on, till someone misses."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "One Eighty Five",
          :description => "Not really improv theater but done by a quite a few troupes, and fun when done well. Get a term, e.g. `Elephants`. The lines go like 185 elephants walk into a bar The bartender says \"Sorry but we don`t serve elephants here\" (witty line that`s the reply of the elephants ) Players basically come up with an instant joke about 185 whatevers that enter the bar. As we said, not really theater..."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "One Line Scene",
          :description => "Play a one or two minute scene, where only one line of dialog can be spoken. Indicate to the players when they have, say, 20 seconds left. This exercise teaches players what can be communicated using non-verbal communication. Things like, `thank you`, `I love you`, `I appreciate this`, `I`m sorry\" and so forth can all be communicated non-verbally."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
             :see_also => [],
           :variations => [
            "You can tell players they can vary the way they extend their hands or hand. They can hold hands in front of them, above their head or close to the ground. See if different stuff shows up. A slightly less difficult version of this game can be done by having players put their hands in their pockets and take something out. Make sure they all got pockets if you want to play this game. This version is slightly easier, as anything in their pockets, like dust, or the way the fabric feels, can trigger and idea; when holding your hands out there is very little to trigger an idea. Origin Keith Johnstone describes similar games in his book Impro ."
        ],
        :also_known_as => [],
                 :name => "Open Your Hand",
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Opposite Characters",
          :description => "This is basically the opposite to Imitate : for the shopkeeper, rather than imitating the customer`s character, try and build a totally opposite character. As a side coaching, point players to the following character treats: voice (loud/soft/harsh ? intonation?) Status (high/low?) Age? Occupation? Way the body moves? (take a look at Fast Food Laban for more on movement) Note that this is also a looking/listening exercise for the shopkeeper!"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Opposites",
          :description => "Let the players walk around the room in silence. Ask them how they would classify themselves: high or low Status loud or silent caring or careless strong or weak tall or small secure or insecure clumsy or perfect happy or sad introvert or extravert basically anything that would be a character trait nThen ask them to imagine they are exactly the opposite of all these character traits. Ask them to move about like such a character. Then play scenes in which the players `become` the opposites of their own characters."
    },
    {
             :see_also => [],
           :variations => [
            "The interviewer can raise the stakes, e.g. by pimping the expert into a Word at a Time Song.",
            "In Oracle version, use an ancient Greek oracle instead of an expert, and have the audience ask the oracle questions about life and love."
        ],
        :also_known_as => [
            "Two-headed Professor",
            "Oracle"
        ],
                 :name => "Word at a Time Expert",
          :description => "3 players: one is the interviewer, and the other 2 are an expert on a subject chosen by the audience. The expert is really one person, with 2 heads, and answers to the interviewer`s question are provided word by word, one word at a time per player."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Overload",
          :description => "Excellent exercise to train listening skills by means of sensory overload. 4 players. One plays and stands centrally. This player has to: answer simple arithmetic questions posed by left player answer simple personal questions posed by right player mirror the movements made by the player in front of her If the central player misses something, or fail to answer a question, the player who is not followed keeps saying `Beep beep beep` until the question is answered or the movement is mirrored. Rotate players after a few minutes so everyone gets their turn."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Paperclip Game",
          :description => "This is a great improv exercise for teaching players to recognize patterns and heighten what has been established. Everyone forms a backline. One person steps forward and says what object he is and what his function is, like \"I'm a paperclip, and I hold loose papers together.\" A second person steps up and says what object he is, and what his similar function is, like \"I am a rubber band and I hold loose pieces of mail together.\" At that point a pattern is established and everyone just steps forward one-by-one and heightens the pattern: I am twine and I hold loose recyclable newspapers together. I am shackles and I hold loose chain gang prisoners together. I am religion and I hold loose communities together. Repeat until it's as heightened as it's going to get, then start over again with a new object and function."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
          ...
          :description => "This is an interesting improv handle: the audience provides 2 different environments/locations. Then 2 pairs of players play 2 improvised scenes, one in each environment, but the scenes are played at the same time (on the same scene, of course). Players do not acknowledge characters or events that do not happen in their scene. Be careful to allow both pairs for `scene time`."
    },
    {
             :see_also => [],
           :variations => [
            "Use quirks instead of characters"
        ],
        :also_known_as => [
            "Party Quirks"
        ],
                 :name => "The Party",
          :description => "One player plays a character that is having a party. The other players will be the guests, and the audience provides us with who the guests might be. Of course the host does not know who the guests are. His task is to guess who the guests might be, based on hints the guests offer. The games is over as soon as the host has guessed all guests."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Pass Ball",
          :description => "All players in a circle. Ask the players to pass a mimed ball to others (one ball at a time). Then side-coach: the ball becomes heavier, until it weighs a ton, or extremely light, extremely big (and light or heavy) or extremely small (and light or heavy). We need to `see` the ball`s characteristics in the way it gets passed."
    },
    {
             :see_also => [
            "Synchro Clap",
        ...
        :also_known_as => [],
                 :name => "Pass Clap",
          :description => "Classic warm-up. Everyone in a circle. One player starts by throwing a hand clap to her right neighbor, and the neighbor passes the clap to his right neighbor. Play this till the clap really flows nicely around the circle. Then tell the group that players may decide to pass the clap back to the neighbor they got it from. Try it and notice how disruptive this can be."
    },
    {
             :see_also => [
            "Pass Clap"
           ...
           :variations => [
            "See Pass Clap's variations"
        ],
        :also_known_as => [],
                 :name => "Pass Yes",
          :description => "This is a bit like Pass Clap and all it`s variations. One player starts by saying `Yes` to her lefthand neighbor. Neighbor does the same, passing the `Yes` to her lefthand neighbor. Or she decides to say `No`, after which it`s her right-hand neighbors turn.\n          Try and pass the `Yes` along the circle as fast as possible.\n          When everyone`s got this. Do the same but with eyes closed."
    },
    {
             :see_also => [],
           :variations => [
            "Instead of passing the sound/gesture to your neighbor, players can pass it to any player in the circle. Try the game without imitating the sound/gesture received; just have players turn around and throw a new gesture/sound to their neighbors as fast as possible."
        ],
        :also_known_as => [
            "Pass Catch"
        ],
                 :name => "Sound Circle",
          :description => "Everybody in a big circle. One player starts the game by making a gesture and a sound to his right neighbor. The neighbor immediately imitates gesture and sound, then turns to his right neighbor and makes a totally different gesture and sound. Tell players not to preconceive, ask them to throw themselves into this exercise."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Patterns",
          :description => "This is a bit like Free Association Circle , except that player are not to freely associate on the previously heard word, but on the ensemble of what has been heard, thereby heightening is. Example: grass, plant, flower, tree, forest, jungle. Restart as soon as you can heighten any more."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Pauze",
          :description => "Great exercise to teach improvisers to listen. This is basically a 2 player dialog. Every player needs to wait 5 seconds before replying. The idea is that this forces the improvisers into really considering what was said to them, how it was said and why it was said."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Pecking Order",
          :description => "Every player picks a number between 1 and the number of players in the scene. Numbers are kept secret, so doubles are possible and allowed. Then a scene is played in which each player tries to play the status picked; 1 being the highest status. Obviously they don`t know which numbers the others picked, so each player will have to choose how to position his or her status with respect to each other player, and this choice can be wrong. Most fun if several players pick highest or lowest status."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Peruvian Ball Game",
          :description => "Everyone starts milling about the room, miming a particular kind of ball. It can be light or heavy, have a texture, whatever, as long as it is particular. At the trainer`s sign, everyone passes their ball to someone else. This is done a couple of times, after which everyone tries to find back his or her ball. Origin Described in Augusto Boal `s Games for Actors and Non-actors ."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Pillars",
          :description => "Put one member of the audience on stage (the pillar). A scene is played, but each player can at any point stop his sentence and ask the Pillar to provide the next word."
    },
    {
             :see_also => [],
           :variations => [
            "Allow a third character to enter the scene, playing against the two others. Now the lines are done word per word, by 3 players, but we have 2 characters. This gets extremely silly/messy - to create some order out of this chaos make sure the third player (i.e. the second character) has a different voice (different accent or pitch). Unlikely to produce interesting stories, but quite hilarious."
        ],
        :also_known_as => [
            "Ping Pong"
        ],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Play Tag",
          :description => "Just play tag. Excellent physical warm-up. Tell players to take risks, see how close you can get/stay to the tagger without being caught. See SloMo Tag for an exercise to follow this one."
    },
    {
             :see_also => [
            "Bucket"
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Poet Translator",
          :description => "A simple translation game. The setup is a foreign language poet, who performs some of his work in Gibberish . The translator translates. Nice is number of lines, metrum, and rhymes are kept."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Poetry Corner",
          :description => "You may want to practice this one: 1 player starts with the first line of a poem; player 2 adds second line, and so forth. Try different formats: limericks, sonnets, haikus etc..."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "On stage actors \"pop up\" from a lying position as a narrator tells the story, or introduces the next scene. The narrator may \"pull the tab\" or \"turn the wheel\" to put some action in the page. Justification should be placed on both the narrator and the pop-up actors at various times throughout the story. You can either have the whole story \"told\" by the narrator, or use the flip-of-the-page as your Edit mechanism. In the latter case, once the whole scene has popped-up, a player may start playing, talking, walking around."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Presents",
          :description => "Great warm-up exercise that helps you blank your mind. Good for control freaks. Players stand in pairs and give each other presents. To give a present, you just open your arms/hands to indicate you`re holding something. Don`t try to think about what you`re holding, but give it to your companion. Upon receiving the present, you give it a name, the first thing that comes to mind. You say something like `Oh, thanks, a little dead bird`. You promptly ignore your present and return something else to your companion. This game works best if it`s played fast, so players really don`t have the time to preconceive. It`s also nice and positive, as everybody is always extremely happy with their presents, no matter what they are. n If players complain they always receive the same present (\"It`s always a book\") tell them this is quite ok - they should be happy to receive so many books. See also Spontaneity for related games."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Primal Screams",
          :description => "All players in a circle. On player steps into the circle, making a big gesture and a loud sound. Player then steps back, and the rest of the circle imitates the sound and gesture. Try and do this with open sounds, as loud as possible. As Keith Johnstone says: \"Yelling `en masse` is good for the soul\"."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Protest Song",
          :description => "Ask the audience for something that pisses them off. Then improvise a song about it, like the 70s screw-the-government type characters. Typically done as a Verse-Chorus type song."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Puppets",
          :description => "4 players. 2 players will be puppets; these players offer the lines of dialog in the scene, but they are not allowed to move about themselves. The other 2 players are the puppet masters, that will provide the movements for the puppets."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Rash",
          :description => "nMake sure you have as many pieces of paper as there are players. Write `cure` on all but one, and a disease (like `rash`) on one. Each player draws a piece of paper, but no-one knows who`s got the disease. Then find the disease and cure it."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Receiver Right Clap",
          :description => "Nice concentration and warmup exercise. All players in a circle. Players can throw a `clap` to any other player by pushing their hands together in front of their chest (like a praying gesture), and then pushing both hands towards the receiving player, opening up their arms as they do so. Sending a `clap` makes a `Whoof` sound; receiving a clap makes a sucking sound. The receiver receives the clap by making the inverse gesture, and uttering a sucking sound. Once a clap is received, the player to the right of the receiver sends a new clap to any other player. And so one. Once everyone`s got it, switch to left-hand side player of the receiver to send the next clap."
    },
    {
             :see_also => [],
           :variations => [
            "The player doing the movement controls the player doing the sounds. Alternatively, each player leads in turn without a predefined order."
        ],
        :also_known_as => [],
                 :name => "Remote Control",
          :description => "Players in pairs. One player, uses her voice and body to produce any sound she wishes. The other player interprets those sounds through movements, acting in synchronization with the first player's \"sound track\". Exchange roles after a while."
    },
    {
             :see_also => [],
           :variations => [
            "Bring the object back to the shop where it was purchased. Shopkeeper should give hints as to what the object is.",
            "In \"Veterinarian Endowment\" version, instead of an object, use an animal that is sick, dead or does not do what was promised. Like a parrot that refuse to speak.",
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Repeater",
          :description => "Listening exercise. Any player that wants to offer a piece of dialog needs to repeat the entire dialog the last player did (ignoring that player`s repetition of previous dialog) before she can offer her own input. Obviously not for performance."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Replay Gibberish",
          :description => "Exercise on Jabbertalk . Have 2 players do a short scene (1 minute or so). Then have them replay the scene in gibberish."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Reverse Chair Dance",
          :description => "You will need music for this exercise, and a bunch of chairs. Start by placing chairs in a circle, one chair less than the number of players. Play music, and have the players dance around the chairs. When the music stops, everyone should find a chair to sit on. The player that doesn`t find a chair needs to find some other way to get his/her feet off the ground. Remove a chair and repeat. In the end, all players will have to find a way to not to touch the ground, by climbing and clinging on to each other. Make sure you got sturdy chairs; we`ve known chairs to collapse under the weight of 10 players ... It`s important not to side coach - the group needs to figure out themselves how to solve the problem."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Reverse Trivial Pursuit",
          :description => "Like most of the games in the Verbal wit category, no exactly theater, but fun if played well. Ask the audience for statements or facts, to which the players need to come up with the funniest question to which the statement/fact might be the answer. Example: Statement: \"Green Bananas\" Question: \"What is best avoided if you got constipation?\""
    },
    {
             :see_also => [
            "Verses"
        ...
        :also_known_as => [],
                 :name => "Rhymes",
          :description => "Scene played in verses. The idea is that the first player offers a line, and the second player rhymes to that. Then the second player offers another line, with which the first player needs to make a rhyme. Players that hesitate or forget to rhyme `die` and are replaced by other players. The idea is to keep the story going, so players that can`t find a good rhyme that would advance the story better die than screw up the story."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Rumors",
          :description => "Everyone in a circle. One person starts by saying \"Did you hear about ...\" and points to someone else. That player immediately replies affirmative and heigthens. After which everyone gasps or giggles. Person left to the second person restarts. The blanks can be anything: something as simple as soup, or something as convoluted as the white bear who ate a Russian kid for lunch in Novosibirsk last Thursday."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "Excellent listening exercise. Players in pairs. Establish a beat. Player 1 provides a story, one word per beat. Player 2, within the beat, repeats the story, but with one beat delay (like the delay we have on a satellite radio). Try with 2 or 3 beats delay as well."
    },
    {
             :see_also => [
            "Satellite Radio",
        ...
        :also_known_as => [],
                 :name => "Satellite TV",
          :description => "Same as Satellite Radio, but with movements. Players in pairs. Establish a beat. Player 1 makes a new movement on every beat. Player 2 mirrors the movements, but with a delay of 1 beat. Try a delay of 2 or 3 beats as well."
    },
    {
                :notes => [
        ...
        :also_known_as => [],
          ...
          :description => "Fairly obvious: a scene is played in the dark."
    },
    {
             :see_also => [
            "Asides"
        ...
        :also_known_as => [],
                 :name => "Scene Painting",
          :description => "Technique for building/advancing scenes. To be used sparingly. The idea is that any player can stop the scene by yelling freeze, step out of character, and describe something within the scene, without interrupting what is going on in the scene. After nthe comment, player unfreezes the scene and steps back into character. Example. 2 players in a scene where a backpacker is looking for a bed at a house where an old lady lives. Backpacker comments on the fact that the house is chock full of stuffed animals, an little pictures of backpackers, thereby implying that the old lady kills and stuffs backpackers (idea stolen from a short story by Roald Dahl)."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Scene To Music",
          :description => "A silent scene is played, in which the characters` emotions are controlled by the music."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Script Tease",
          :description => "This is a Long Form format. Instead of getting suggestions from the audience, a (preferably well known local) writer is invited to provide the first two pages of a non existing novel. These pages are read to the audience (preferably by the writer herself) and the rest of the story is then improvised. Origin The format is attributed to the National Theatre of the World in Toronto. As far as we know the format is copyrighted; you'll need permission to perform it."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Seven Up",
          :description => "Everyone in a circle, start counting to 7 while waving right arm up and down to the same rhythm you`re counting. After 7 switch to the other arm, then the right leg, then the other leg. At the end of the last leg of 7 go back to the original arm and do the same thing counting to 6, and so on down to 1-1-1-1."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Sideways",
          :description => "In this game we play a scene, in which the back wall is the `floor`, and the floor is a wall. So, if you are `standing` in the scene, you would be lying on the floor, and if you`re lying down, you`d really be standing against the back wall. This setup allows players to so all kinds of weird things, like defying gravity, or become a bat that`s hanging upside down off the wall."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Silly Stinky Sexy",
          :description => "4 players. Each player endows each of the other players with either sexy-ness, silly-ness or stinky-ness. Have them play a scene in which people come together, at a party, a picnic, in church. Afterwards, ask the audience if they could see who endowed who with what."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Simon Says",
          :description => "You are Simon, and you tell the players to do exactly what Simon tells them to do, but only if Simon`s sentence starts with \"Simon says\". Any time a player does what Simon tells her to do, without preceding that with \"Simon says\" is out. Tell the players the game starts when you say \"Simon says the game has started\". Then try to trick them into doing stuff they`re not supposed to do. Ask them e.g. if they understand the rules; whoever nods is out. Try telling players that are out they can join in again; if they do they`re out again."
    },
    {
             :see_also => [],
           :variations => [
            "Improv team Icebox suggests using the same instructions but swapping out the actions of sitting, standing, and lying for the emotions of happy, sad, and angry."
        ],
        :also_known_as => [
            "Glad Sad Mad"
        ],
                 :name => "Sitting Standing Lying",
          :description => "Silly game to teach fast acting. 3 players play a scene. At any point in time, there should always be one player standing, one player sitting and one player lying down. As soon as a sitter stands up, the stander needs to sit down. Try to justify the moves !"
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Slap Take",
          :description => "Very silly: 2 players do a scene. Every time a player makes the audience laugh the other slaps her."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Slappy Face",
          :description => "A simple word association played in pairs. If a player is too slow, of goed `Erm...` the other slaps him in the face (gently). Adding the notion of danger helps some people to say whatever comes to mind."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [
            "SloMo World Champion"
                 ...
                 :name => "Sportz Center",
          :description => "3 players, and an every day activity (brushing your teeth, washing your car). In this game, the every day activity is performed as if it were done at the olympics or at a world championship. One player is the athlete, and the two others are in a TV studio - one is the interviewer who interviews the athlete`s trainer, as the athlete performs the task. Usually, something goes wrong and the athlete fails miserably. Gimmicks may include: Interviewing the athlete on the field after the win (or the disaster) Asking for a replay of a particularly dramatic moment Asking for a replay with a different camera (different angle)"
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Soap Series",
          :description => "Play an episode from a soap series. This can be done as a Long Form , but can also be used in short form. The idea is to use (and abuse) the techniques used in soap series. Typically this involves several story lines running at the same time, each story progressing in tiny steps. Other elements that can be used or spoofed are: poor acting settings like oil industry, hospitals, fashing industry situations where everyone is involved with everyone, including weird plot twists where characters suddenly discover they are related."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Solitaire",
          :description => "All players but one spread along opposing edges of a wide surface. The player in the middle runs from one end of the space with closed eyes. The others prevent the runner from deviating too much left/right, and catch the runner at the end. This is more difficult than it sounds - it`s like after a couple of steps most people start sensing a looming wall in front of them."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Solo Doors",
          :description => "A Solo exercise. Enter, as a character, through a door. Make the environment clear (by means of the (kind of) door. In that environment, address your character as a different character, then one of the characters (you again) leaves (through the door, or through another door/window/hole/whatever). Do this fairly fast and long enough so you run through your easy characters. You can shelve any interesting characters you discover of course. Excellent exercise to help you establish the Platform . This is like a solo variation on Ding Characters ."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Sound Effects",
          :description => "A scene is played, and one or more off-scene players provide all the sounds. Players on scene are allowed to speak, but cannot make other sounds. The idea is that the FX folks add to the scene, not merely support it."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Sounds Like a Song",
          :description => "Play a scene (or series of scenes). At any time, anyone can stop the scene and say `Sounds like a song`, after which the player(s) sing a song based on the last line that was spoken, or last action that was done."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Spit Take",
          :description => "Very silly: 2 players do a scene, each holding a glass of water (or coke, or beer). After every sentence players take a spit. Or take a spit after the other player said a line. Or both."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "A standard musical is a Straight Story wrapped as a musical. A musical typically starts with a big opening number, and ends with a big finale."
    },
    {
             :see_also => [],
           :variations => [
        ...
        :also_known_as => [],
                 :name => "Story Spine",
          :description => "This is an idea/tool about the spine of any story. The whole point of the tool is to provide a model for a well-constructed story with a beginning that establishes a routine, an event that breaks the routine, a middle that shows the consequences of having broken the routine, a climax that sets the resolution to the story in motion, and the resolution. It goes like:\n                          Once upon a time...\n                          Every day...\n                          But, one day...\n                          Because of that...\n                          Because of that...\n                          Because of that... n\n                          Until, finally...\n                          And, ever since then...\n                          And, here's how the lines correlate to the different sections of a well-constructed story:\n                          The Beginning that establishes the routine: Once upon a time... Every day...\n                          The Event that breaks the routine: But, one day...\n                          The Middle that shows the consequences of having broken the routine: Because of that... \n                          Because of that... \n                          Because of that... \n                          The Climax that sets the resolution to the story in motion: Until, finally...\n                          The Resolution And, ever since then...\n                          This little structure teaches performers to advance a story by changing things."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Story To A Chair",
          :description => "A Solo character exercise. Tell a story to a few chairs. Any story, and the story does not really matter. Then, as you go, start playing all the characters. Feel free to narrate in between. Make your story such that it becomes easy to establish the character. Start with something like `Jodi didn`t really like leaving the house` -- which would point yourself to playing somebody with an outdoor phobia."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Stunt Double",
          :description => "A scene is played by 2 players. Every time a player needs to do something difficult/unpleasant, another player jumps in as a stunt double. When done, the stunt double freezes the scene and the original player continues the scene."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Sung Story Die",
          :description => "This is like Story Story Die , but sung. Get a suggestions, and sing a song to that suggestion. When the host points to another player, that player continues the song. Both music and lyrics should fit flawlessly, otherwise the player is out. Can be done with an without a musician. Without is a bit easier as the rhythm can be broken a bit more easily. Then again, continuing the musical line can be more difficult."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Superman Jam",
          :description => "Divide the audience into three groups; label them Group 1, 2, 3, (or any other labeling). Each group gets their own phrase to sing (or yell); it`s important that the rythm and length of each phrase is identical. Group 1 sings \"Superman, Superman, Superman, Superman\" Group 2 sings \"I want to jam with Superman. I want to jam with Superman.\" Group 3 sings \"I want to jam; I want to jam; I want to jam with Superman.\" Then, the MC directs the audience through singing the song, first one group, then two, then all three, then just two, then just one, then two, then another loud, another soft, etc."
    },
    {
                 :tags => [
            "pimping"
        ...
        :also_known_as => [],
                 :name => "Supermen",
          :description => "A great Pimping game. 4 players. First player gets from the audience a silly little problem, like My Shoelaces are Untied, and a simple object, say a kitchen cabinet. First player starts a scene in which the Problem arises, and her character is unable to fix the problem. Hence she calls in (explictly) the help of Kitchen Cabinet Man. This is a SuperHero, like Superman, Spiderman, you know that kind of cartoon-character heroe types. Our Superman comes in with lots of brou-haha (high Status ) only to make the problem worse (and a status switch to low status). So our hero calls in the help of yet another Superman. Use whatever you can think of first. Say Toothpaste Man. Again this hero comes in high status, screws up even more, does a status switch and calls in yet another hero, who finally fixes the problem. The game is really pimping folks into playing outrageous superheroes. The status switch from high to low after screwing up is pretty important too here."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Survivor",
          :description => "Four to six players play a scene. Then the audience chooses one of the players to get \"voted off the island.\" The remaining players do the scene again, covering everything that happened the first time. Then another person gets voted out, and so on until one person has to act out the scene all by themselves. There are various ways of re-playing the original scene, even when only one player left: player can do a monologue, can play all original characters herself, you name it ... You can play this for an audience, but it`s also a great listening and paying-attention exercise. Origin The Improvoholics mailed us to claim they developed this game. Thanks guys!"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Swedish Sculptors",
          :description => "This one is an extension of Sculptors . Divide the class in 2 groups, same number of players in every group. One group is clay, and they close their eyes. The other group are sculptors. The sculptors build one sculpture out of all the `clay` players. The sculpture is finished when all of the players touch someone else (so all are connected to the sculpture). The artists cannot `push` the clay into position - they need to `pull` parts of the clay into position without actually pulling. `Pulling` is done by touching a body part with an open hand, and then moving the hand about. They `clay` players need to `follow` the moving open hands. As soon as the sculpture is finished, the sculptors moves away, and re-build the statue, themselves now becoming clay. The (original) clay players keep their eyes closed. As soon as the imitation sculpture is finished, the clay players, eyes still closed, try to find `themselves` in the imitation. When everybody has found themselves the game is over, and the clay players assess to what extent they found `themselves` and to what extent the imitation is exact. Origin Described in Augusto Boal `s Games for Actors and Non-actors ."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Switch Gibberish",
          :description => "Jabbertalk exercise: let a player tell a store. Whenever you ring a bell (or clap your hands) player switches to Gibberish - the story should continue and should make sense. If you do this as an exercise, try sidecoaching with different kinds of gibberish. Try any language you don`t know (Mongolian, Italian, Russian, Chinese, you name it)."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Sybil",
          :description => "This is basically a one-person Long Form . In this format the player plays all characters. The play typically starts with a character monologue and then goes into scenes alternated with more monologues. One could summarize the `rules` as: you play all the characters and their dialogue in the scenes monologues are either internal (to the character) or to the audience, addresses as a group (a minister preaching to a church, a person introducing himself at a job interview). Origin The format is attributed to Andy Eninger. The name is based on a book with the same title, about Sybil Dorsett, a survivor of child abuse who was diagnosed with the first multiple personality disorder. She alledgedly played host to 16 separate personalities. More info can be found on www.sybilization.com."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Synchro Clap",
          :description => "All players in a circle. One player starts the game by making eye contact with another player. Then, both clap their hands simultaneously. The `receiving` player then makes eye contact with another player, and they synchro-clap. And so on. Once a firm rhythm is established, start accelerating slowly."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "TagOut",
          :description => "This is a format, and an performance trick at the same time. As a format, it can be used for Short Form performances as well as for Long Form work. The premise is simple: Transitions between scenes are made by tagging out (a) player; the other player(s) remain in the scene and the person who tagged joins in, starting a scene at a different time and/or location. TagOuts as a format are described in Art by Committee, and the book has good examples on the video included."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "The Bat",
          :description => "This is a Long Form format based on Blind Harold . It is basically a long form played with the lights out in a theater. You can download mp3 files of a couple of Bat performances off the website of the Impatients . Origin The format was created by Joe Bill of Annoyance Theatre in Chicago."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "The Good, the Bad and the Ugly Advice",
          :description => "3 players, form a line (or sit down). The audience provides questions or problems for which they need advice. The 3 players provide good, bad, and really bad advice. Have the MC choose who provide what advice, so everyone can have a stab at really bad advice. If the `bad advice` is really bad, then the Ugly advice should be even worse. You can play this as a Die game - if a bad advice is not followed by an even worse advice, replace the last player by another one."
    },
    {
             :see_also => [
            "Swedish Sculptors"
        ...
        :also_known_as => [],
                 :name => "The Magnet",
          :description => "Played in pairs. One player becomes a sculpture, standing still, while his partner closes her eyes. She needs to explore the statue, with her eyes closed, and then tries to become the same statue."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "The Re-Run",
          :description => "An excellent exercise for Look and Listen . One player initiates a scene. Take your time establishing Platform . A second player joins the scene; this player may 'come in', or alternatively he may have started on scene with the initiator. After the initiator has spoken his first line, the joiner repeats exactly what the initiator said. Then we interrupt. Ask the joiner what was established prior to the first line, as well as what the first line established. This slows down the scene so the joiner gets the time to fully grasp what his scene partner has given him. This goes both ways - what did the initiator get from the joiner (non-verbally)? Then re-run the start of the scene and let it develop."
    },
    {
             :see_also => [],
           :variations => [
            "for the different sub-formats: The game is introduced by an MC, who does a warm-up and then introduces the judges and the 2 teams The game is lead by judges Each game has a fixed duration A toss decides which team starts with a challenge Challengers go first. Possible challenges are the classic games, but anything goes. One might challenge the other team to play the dullest scene possible. Teams can protest or baulk at a challenge. The judges may accept the baulk, in which case the challengers need to come up with a new challenge. Reason for baulking at a challenge might be \"we`ve already done this game tonight\". The judges carry a horn, which they use to issue a warning for boring. After a warning the scene should be concluded ASAP. Judges can issue penalties, for e.g. obscenities, smart-assing or whatever. A punished player gets a basket over his head for a number of minutes Scenes must end on time; the judges indicate the time, and warn the players e.g. when they got 30 seconds left. Or they honk a warning for boring, after which the scene must end. After each challenge (played by both teams) the audience decided by means of cheering, yelling of applause which team won, as interpreted by the judges. Winners get 5 points, losers get nothing. The whole show lasts about 45 minutes.",
        ...
        :also_known_as => [],
                 :name => "Theatresports",
          :description => "Theatre Sports is really a collection of formats. We`ll summarize the general rules, and then describe the"
    },
    {
             :see_also => [
        ...
        :also_known_as => [
            "The Ad Game"
                 ...
                 :name => "Yes Lets",
          :description => "Excellent warm-up, and great introduction to Accepting . Pick a group activity, like throwing a party or organizing a picnic. One player starts, saying \"Let`s ...\" filling in what she wants to do. Then she starts actually doing what she said she wanted to do. A second player jumps in, saying \"Let`s ...\" do something else, to advance the group activity. Both players say \"Yes, let`s do that\" and start doing whatever suggested. Third player jumps in, suggests what to do, and again all players loudly agree to do it, and actually do it. Continue till everyone has suggested something."
    },
    {
             :see_also => [
            "Doors"
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Three Line Environment",
          :description => "Played with 2 players. They get 3 lines (first player gets 2 lines, second one gets one line). Using no more than 3 lines (A-B-A) they need to establish their Platform ; who they are, where they are, when and why."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Three Line Solo",
          :description => "This is a Solo exercise. Play a 3 line scene with 2 characters. Play both characters yourself. Repeat at high speed so you run through your `easy` characters fast."
    },
    {
             :see_also => [
            "Bartender"
        ...
        :also_known_as => [],
                 :name => "Three Melodies",
          :description => "Ask for 2 occupations. Then do a 4- beat scene as follows: Player 1 sings about how great and satisfying her job is, but she`s missing something critical, or has a minor little problem with it (melody 1) Number 2 does the same (to a second melody) Both characters meet in a bar, complaining about their problems. They summarize their problem in one line each (to finish their song), something like \"I got plenty of x but I`m missing y\" Then they solve each other`s problem (fitting each other`s x to the other`s y), they do this in a duet to a third melody."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Three Sentence Story",
          :description => "2 players. 3 unconnected sentences are provided by one player; the other builds the shortest possible story incorporating the 3 sentences."
    },
    {
             :see_also => [
            "Scene Replay"
        ...
        :also_known_as => [],
                 :name => "Timed Scenes",
          :description => "Here are a couple of different ways to time scenes (apart from using your watch) time a player can keep his head immersed in a bucket of water time it takes the audience to throw 20 socks onto the stage time it takes for an audience member to finish a beer (or a series of beers) time it takes a player to go get a burger"
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Tossing",
          :description => "Eight players form 2 lines, facing each other, and mesh their forearms together, to form a platform to `launch` another player up in the air and catch him again. Do make sure that your platform is sturdy (holding the other players by the wrists seems to be most solid)."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
             :see_also => [],
           :variations => [
            "Some folks play each act in a different style, usually a kind of play (say Shakespeare), a kind of movie (say a spaghetti western) and something musical (say a musical or an opera). Origin The format was invented by Forrest Brakeman at LA Theatresports in 1989; it is licensed (you need a license to perform the format). Since 1989 LA Theatresports has morphed into Impro Theatre (LA)."
        ],
        :also_known_as => [],
                 :name => "Triple Play",
          :description => "This is really a series of 3 3-act plays mixed. Three separate plays are played, each based on different audience suggestions, and not related at all. We first see the three first acts for every play, then the three second acts, and finally the three final acts."
    },
    {
             :see_also => [
           ...
           :variations => [
            "Read the answer, and let the players come up with the question."
        ],
        :also_known_as => [],
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Tug-O-War",
          :description => "Divide the class in 2 groups and have them mime a Tug-o-war fight. See if the mimed rope does not stretch or shrink somebody wins (i.e. one group gladly looses (see Chivalry )"
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Turkish Army Drill",
          :description => "Great physical warm-up. We define 4 gestures, and each gets a number: One: touch your forehead with your hands Two: touch your shoulders with both hands Three: touch your hips with both hands Touch one foot with one hand (lift your foot) Game now goes as follows: Say one-two-three-four twice Do gesture one, say two-three-four - do this twice Do gestures one and two, say three-four, do all this twice Do gestures one, two, three, say four and do all this twice Do all gestures in order, twice Repeat all this at high speed."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Turning Circle",
          :description => "Fun game to warm up those muscles and get the blood pumping. Everyone in a circle. The circle starts running (slowly) clockwise. As soon as anybody shouts `go`, the circle changes direction, without anybody bumping into someone else."
    },
    {
             :see_also => [],
           :variations => [
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Typewriter",
          :description => "This is a nice handle to structure scenes. One of the players is the Narrator. He has a (mimed) typewriter and starts the scene by reading aloud as he types. As soon as the Narrator has given a few elements, the players take over and start playing the scene. At any point, the Narrator can take over again, perhaps switch to another location, introduce new character, provide tilts or flashbacks."
    },
    {
             :see_also => [
            "Rhymes"
        ...
        :also_known_as => [],
                 :name => "Verses",
          :description => "Scene is played in verses, that is, every player need to rhyme to herself. Nice handle to combine with a Shakespeare style."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [
            "You can combine this with Last Letter."
        ],
        :also_known_as => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Walking by Numbers",
          :description => "Every player finds himself a spot in the room, make sure players can see each other. When you give a sign, exactly 1 person starts walking. Whenever that person halts, one person, and only one person starts walking. Gradually increase the number of walkers."
    },
    {
             :see_also => [
            "Open Your Hand"
    ...
    },
    {
        ...
        :also_known_as => [],
          ...
          :description => "Played in pairs. One player observes another closely. Then she closes her eyes, and her partner changes three things in his appearance. She open her eyes again and tries to discover what has changed."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Who Stole the Cookies",
          :description => "Classic game to learn each other's names. Group (sings in a rhythm): Who stole the cookies from the cookie jar? (player who is \"it\" inserts name of player) stole the cookies from the cookie jar! Player: Who, me!?!?! Group: Yes, you! Player: Couldn't be! Group: Then who? (Player uses another player's name) stole the cookies from the cookie jar!"
    },
    {
             :see_also => [
            "Hijacker"
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Without Sound",
          :description => "A scene in played, in which no talk of no sounds are allowed."
    },
    {
             :see_also => [
            "Without Sound"
    ...
    },
    {
           ...
           :variations => [],
        :also_known_as => [],
                 :name => "Word at a Time Letter",
          :description => "Play in pairs. The 2 players will compose a letter, one word at a time. Have them actually write down the letter. Anything, even `where` on the paper one starts writing, is an offer. No need to sidecoach, but the possibilities are endless; thing about greeting cards, love letters, legal stuff, promotional letters, suicide notes, etc."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Word at a time proverb",
          :description => "Players in a circle. One player starts with first word of a (non-existing) proverb; circle continues, one word at a time, until the group 'feels' the proverb is done; at that point everybody says 'yes yes yes yes'. Hint: start with (a) typical proverb word(s), like 'A', 'He who', etc."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Word at a Time Song",
          :description => "This is like Word at a Time Scene , but here the players improvise a song. Song can be sung to a known melody (makes things a bit easier), or on a tune played on the piano. Tell the piano player not to play too fast, though."
    },
    {
             :see_also => [],
           :variations => [],
    ...
    },
    {
           ...
           :variations => [
            "Try this in combination with Last Letter or Free Association Lines",
            "Instead of just tossing word, have the players throw a soft ball, or a towel tied in a knot to each other try with multiple `tossers` at once."
        ],
        :also_known_as => [],
                 :name => "Word Ball",
          :description => "Another association game. All players in a circle. One player starts by tossing a word to another player. The receiver associates on this word, and throws his association to yet another player."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Worlds Worst",
          :description => "Not exactly theater, but fun if played well. Players line up, and the audience provides verbs, hobbies and occupations. The players need to come up with the worst possible way of doing/being what the audience suggests."
    },
    {
             :see_also => [
            "Yes Lets"
    ...
    },
    {
        ...
        :also_known_as => [],
                 :name => "Zapping",
          :description => "4 players, each chooses a TV format, like the News, a documentary, a Pokemon show, you name it. The audience provides a central theme, and the MC will `zap` through the channels. Miraculously, all broadcasts cover the same theme."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
                 :name => "Zombie Name Game",
          :description => "Great game to get to know each other. All about the room, one player is the zombie; she moves, zombie-style, arms stretched out in front of her, towards one player. Before she reaches that player, he needs to yell the name of another player, and the zombie heads towards that player. If the zombie reaches a player before he yells another name, that player becomes the zombie."
    },
    {
             :see_also => [],
           :variations => [],
        :also_known_as => [],
          ...
          :description => "A scene is played; at any time the MC or host calls \"zoom-out\" - at that point, the scene continues, but is played with finger puppets (as if the audience is nwatching the scene from fart away, and all characters are finger-sized). This continues until the host calls \"zoom-in\", after which the scene continues in \"normal\" size. Alter between zoom-in and zoom-out ad libitum."
    },
    {
             :see_also => [
            "Zulu(2)"
        ...
        :also_known_as => [],
                 :name => "Zulu(1)",
          :description => "All players form a line, facing the audience. Audience suggests a general product category, like soup or family cars. Players then have to come up with original new names for (new) products in that category."
    },
    {
             :see_also => [
            "Zulu(1)"
